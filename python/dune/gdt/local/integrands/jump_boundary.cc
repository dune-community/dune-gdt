...
class LocalBoundaryJumpIntegrand
{
...
public:
  using type = GDT::LocalJumpIntegrands::Boundary<I, r>;
  ...
  static bound_type bind(pybind11::module& m,
                         ...
                         const std::string& class_id = "local_boundary_jump_integrand")
  {
    namespace py = pybind11;
    using namespace pybind11::literals;

    const auto class_name = class_id + "_" + LocalBinaryIntersectionIntegrandInterface<G, I, r>::id(grid_id, layer_id);
...
struct LocalBoundaryJumpIntegrand_for_all_grids
{
  ...
  {
    Dune::GDT::bindings::LocalBoundaryJumpIntegrand<G, I>::bind(m);

    if (d > 1)
      Dune::GDT::bindings::LocalBoundaryJumpIntegrand<G, I, d>::bind(m);
    // add your extra dimensions here

    LocalBoundaryJumpIntegrand_for_all_grids<Dune::XT::Common::tuple_tail_t<GridTypes>>::bind(m);
  }
};

template <>
struct LocalBoundaryJumpIntegrand_for_all_grids<Dune::XT::Common::tuple_null_type>
{
  static void bind(pybind11::module& /*m*/) {}
};


PYBIND11_MODULE(_local_integrands_jump_boundary, m)
{
  namespace py = pybind11;
