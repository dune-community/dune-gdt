...
#ifndef PYTHON_DUNE_GDT_LOCAL_INTEGRANDS_BINARY_INTERSECTION_INTERFACE_HH
#define PYTHON_DUNE_GDT_LOCAL_INTEGRANDS_BINARY_INTERSECTION_INTERFACE_HH
...
protected:
  ...
  static void bind_methods(pybind11::class_<T, options...>& c)
  {
    ...
    c.def("copy_as_binary_intersection_integrand",
          [](const type& self) { return self.copy_as_binary_intersection_integrand(); });
...
public:
  static bound_type bind(pybind11::module& m,
                         const std::string& class_id = "local_binary_intersection_integrand",
...
#endif // PYTHON_DUNE_GDT_LOCAL_INTEGRANDS_BINARY_INTERSECTION_INTERFACE_HH
