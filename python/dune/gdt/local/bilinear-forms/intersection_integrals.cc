                         ...
                         const std::string& layer_id = "")
  {
    ...
    m.def(XT::Common::to_camel_case(class_id).c_str(),
          [](const typename type::IntegrandType& binary_intersection_integrand, const int over_integrate) {
            return type(binary_intersection_integrand, over_integrate);
          },
          "binary_intersection_integrand"_a,
          "over_integrate"_a = 0);
...
struct LocalIntersectionIntegralBilinearForm_for_all_grids
{
  ...
  static void bind(pybind11::module& m)
  {
    ...
    // ...
    LocalIntersectionIntegralBilinearForm_for_all_grids<typename GridTypes::tail_type>::bind(m);
  }
};

template <>
struct LocalIntersectionIntegralBilinearForm_for_all_grids<boost::tuples::null_type>
{
  static void bind(pybind11::module& /*m*/) {}
};
