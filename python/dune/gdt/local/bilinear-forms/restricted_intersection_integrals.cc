...
struct LocalIntersectionRestrictedIntegralBilinearForm_for_all_grids
{
  ...
  {
    using Dune::GDT::bindings::LocalIntersectionRestrictedIntegralBilinearForm;

    LocalIntersectionRestrictedIntegralBilinearForm<G, I>::bind(m);
    if (d > 1) {
      LocalIntersectionRestrictedIntegralBilinearForm<G, I, 1, 1, F, F, d, 1, F>::bind(m);
      LocalIntersectionRestrictedIntegralBilinearForm<G, I, 1, 1, F, F, d, d, F>::bind(m);
      LocalIntersectionRestrictedIntegralBilinearForm<G, I, d, 1, F, F, 1, 1, F>::bind(m);
      LocalIntersectionRestrictedIntegralBilinearForm<G, I, d, 1, F, F, d, 1, F>::bind(m);
      LocalIntersectionRestrictedIntegralBilinearForm<G, I, d, 1, F, F, d, d, F>::bind(m);
      LocalIntersectionRestrictedIntegralBilinearForm<G, I, d, d, F, F, 1, 1, F>::bind(m);
      LocalIntersectionRestrictedIntegralBilinearForm<G, I, d, d, F, F, d, 1, F>::bind(m);
      LocalIntersectionRestrictedIntegralBilinearForm<G, I, d, d, F, F, d, d, F>::bind(m);
    }
    // add your extra dimensions here
    // ...
    LocalIntersectionRestrictedIntegralBilinearForm_for_all_grids<Dune::XT::Common::tuple_tail_t<GridTypes>>::bind(m);
  }
};

template <>
struct LocalIntersectionRestrictedIntegralBilinearForm_for_all_grids<Dune::XT::Common::tuple_null_type>
{
  static void bind(pybind11::module& /*m*/) {}
};
