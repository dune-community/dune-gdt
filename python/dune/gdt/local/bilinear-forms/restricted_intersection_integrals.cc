...
public:
  using type = GDT::LocalIntersectionRestrictedIntegralBilinearForm<I, t_r, t_rC, TF, F, a_r, a_rC, AF>;
  using base_type = GDT::LocalIntersectionBilinearFormInterface<I, t_r, t_rC, TF, F, a_r, a_rC, AF>;
  using bound_type = pybind11::class_<type, base_type>;

  static bound_type bind(pybind11::module& m,
                         const std::string& class_id = "local_intersection_restricted_integral_bilinear_form",
...
struct LocalIntersectionRestrictedIntegralBilinearForm_for_all_grids
{
  ...
  {
    Dune::GDT::bindings::LocalIntersectionRestrictedIntegralBilinearForm<I>::bind(m);
    if (d > 1) {
      Dune::GDT::bindings::LocalIntersectionRestrictedIntegralBilinearForm<I, 1, 1, F, F, d, 1, F>::bind(m);
      Dune::GDT::bindings::LocalIntersectionRestrictedIntegralBilinearForm<I, 1, 1, F, F, d, d, F>::bind(m);
      Dune::GDT::bindings::LocalIntersectionRestrictedIntegralBilinearForm<I, d, 1, F, F, 1, 1, F>::bind(m);
      Dune::GDT::bindings::LocalIntersectionRestrictedIntegralBilinearForm<I, d, 1, F, F, d, 1, F>::bind(m);
      Dune::GDT::bindings::LocalIntersectionRestrictedIntegralBilinearForm<I, d, 1, F, F, d, d, F>::bind(m);
      Dune::GDT::bindings::LocalIntersectionRestrictedIntegralBilinearForm<I, d, d, F, F, 1, 1, F>::bind(m);
      Dune::GDT::bindings::LocalIntersectionRestrictedIntegralBilinearForm<I, d, d, F, F, d, 1, F>::bind(m);
      Dune::GDT::bindings::LocalIntersectionRestrictedIntegralBilinearForm<I, d, d, F, F, d, d, F>::bind(m);
    }
    // add your extra dimensions here
    // ...
    LocalIntersectionRestrictedIntegralBilinearForm_for_all_grids<typename GridTypes::tail_type>::bind(m);
  }
};

template <>
struct LocalIntersectionRestrictedIntegralBilinearForm_for_all_grids<boost::tuples::null_type>
{
  static void bind(pybind11::module& /*m*/) {}
};


PYBIND11_MODULE(_local_bilinear_forms_restricted_intersection_integrals, m)
{
  namespace py = pybind11;
