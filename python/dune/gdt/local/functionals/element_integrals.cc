...
struct LocalElementIntegralFunctional_for_all_grids
{
  ...
  static void bind(pybind11::module& m)
  {
    ...
    // ...
    LocalElementIntegralFunctional_for_all_grids<Dune::XT::Common::tuple_tail_t<GridTypes>>::bind(m);
  }
};

template <>
struct LocalElementIntegralFunctional_for_all_grids<Dune::XT::Common::tuple_null_type>
{
  static void bind(pybind11::module& /*m*/) {}
};
