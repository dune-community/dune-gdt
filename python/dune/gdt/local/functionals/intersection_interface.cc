...
public:
  using type = GDT::LocalIntersectionFunctionalInterface<I, r, rC, RF, F>;
...
struct LocalIntersectionFunctionalInterface_for_all_grids
{
  ...
  static void bind(pybind11::module& m)
  {
    ...
    // ...
    LocalIntersectionFunctionalInterface_for_all_grids<Dune::XT::Common::tuple_tail_t<GridTypes>>::bind(m);
  }
};

template <>
struct LocalIntersectionFunctionalInterface_for_all_grids<Dune::XT::Common::tuple_null_type>
{
  static void bind(pybind11::module& /*m*/) {}
};


PYBIND11_MODULE(_local_functionals_intersection_interface, m)
{
  namespace py = pybind11;
