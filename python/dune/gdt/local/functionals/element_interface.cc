...
struct LocalElementFunctionalInterface_for_all_grids
{
  ...
  {
    using Dune::GDT::bindings::LocalElementFunctionalInterface;

    LocalElementFunctionalInterface<G, E>::bind(m);
    if (d > 1) {
      LocalElementFunctionalInterface<G, E, d, 1, F, F>::bind(m);
      LocalElementFunctionalInterface<G, E, d, d, F, F>::bind(m);
    }
    // add your extra dimensions here
    // ...
    LocalElementFunctionalInterface_for_all_grids<Dune::XT::Common::tuple_tail_t<GridTypes>>::bind(m);
  }
};

template <>
struct LocalElementFunctionalInterface_for_all_grids<Dune::XT::Common::tuple_null_type>
{
  static void bind(pybind11::module& /*m*/) {}
};
