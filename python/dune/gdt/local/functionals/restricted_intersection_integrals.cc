                         ...
                         const std::string& layer_id = "")
  {
    ...
    m.def(XT::Common::to_camel_case(class_id).c_str(),
          [](typename type::FilterType filter,
             ...
             const int over_integrate) { return type(filter, unary_intersection_integrand, over_integrate); },
          "filter"_a,
          "unary_intersection_integrand"_a,
          "over_integrate"_a = 0);
...
struct LocalIntersectionRestrictedIntegralFunctional_for_all_grids
{
  ...
  {
    Dune::GDT::bindings::LocalIntersectionRestrictedIntegralFunctional<I>::bind(m);
    if (d > 1) {
      Dune::GDT::bindings::LocalIntersectionRestrictedIntegralFunctional<I, d, 1, F, F>::bind(m);
      Dune::GDT::bindings::LocalIntersectionRestrictedIntegralFunctional<I, d, d, F, F>::bind(m);
    }
    // add your extra dimensions here
    // ...
    LocalIntersectionRestrictedIntegralFunctional_for_all_grids<typename GridTypes::tail_type>::bind(m);
  }
};

template <>
struct LocalIntersectionRestrictedIntegralFunctional_for_all_grids<boost::tuples::null_type>
{
  static void bind(pybind11::module& /*m*/) {}
};
