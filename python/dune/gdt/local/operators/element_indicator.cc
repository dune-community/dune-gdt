...
struct LocalElementBilinearFormIndicatorOperator_for_all_grids
{
  ...
  static void bind(pybind11::module& m, const std::string& vector_id)
  {
    ...
    // ...
    LocalElementBilinearFormIndicatorOperator_for_all_grids<V, typename GridTypes::tail_type>::bind(m, vector_id);
  }
};

template <class V>
struct LocalElementBilinearFormIndicatorOperator_for_all_grids<V, boost::tuples::null_type>
{
  static void bind(pybind11::module& /*m*/, const std::string& /*vector_id*/) {}
};
