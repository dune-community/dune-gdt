...
struct LocalIntersectionOperatorInterface_for_all_grids
{
  ...
  static void bind(pybind11::module& m, const std::string& vector_id)
  {
    ...
    // ...
    LocalIntersectionOperatorInterface_for_all_grids<V, Dune::XT::Common::tuple_tail_t<GridTypes>>::bind(m, vector_id);
  }
};

template <class V>
struct LocalIntersectionOperatorInterface_for_all_grids<V, Dune::XT::Common::tuple_null_type>
{
  static void bind(pybind11::module& /*m*/, const std::string& /*vector_id*/) {}
};
...
PYBIND11_MODULE(_local_operators_intersection_interface, m)
{
  ...
  LocalIntersectionOperatorInterface_for_all_grids<XT::LA::IstlDenseVector<double>,
