...
//    BilinearFormInterface<GV>::bind(m, matrix_id, grid_name<G>::value());
...
//      BilinearFormInterface<GV, d, 1>::bind(m, matrix_id, grid_name<G>::value());
...
//      BilinearFormInterface<GV, 1, d>::bind(m, matrix_id, grid_name<G>::value());
