...
public:
  ...
  NeumannConstraints( const DiscreteFunctionSpaceType& space,
  ...
  void apply( LinearOperator& linearOperator, 
              ...
              DiscreteFunctionType& solution ) const 
  {
    ...
    GridExactSolutionType ugrid( "exact solution", 
                                 problem_.exactSolution(), space_.gridPart(),
