...
\begin{document}
  ...
  \section{Introduction}
    ...
    \subsection{Elliptic PDE, finite element discretization}
    ...
    \begin{example}[Elliptic PDE in one dimension]\theoremNewline
      ...
      Let ${\Omega \subset \R}$ be a bounded connected lipshitz-domain and ${a\komma f : \Omega \rightarrow \R}$ and
    ...
    \begin{definition}{Weak formulation}\theoremNewline
      ...
      Let $H^1$ and $H^1_0$ be given as usual and let the affine subspace $H^1_g$ induced by a function ${g\in H^1}$ be
      defined as
      \begin{align}
        H^1_g :=
          \big\{
    ...
    \begin{remark}[Solution of the variational problem]\theoremNewline
      ...
      Let all be as in remark \ref{remark::introduction::variational_formulation_functionals_operators}. Find
      ${u_{0} \in H^{1}_{0}}$, such that
      \begin{align}
        \label{equation::introduction::variational_formulation_in_h_1_0}
        A(u_{0})[v] = F[v] &&\text{for all } v\in H^1_0 \punkt
      \end{align}
    ...
    \begin{definition}[Finite element discretization]\theoremNewline
      ...
      With the notation from above, let $\Tau_h$ be a conform admissable triangulation of the domain $\Omega$ into
      elements $T$. The usual finite element lagrange spaces are then given by
      \begin{align}
        ...
        {S_{h}^{k}}_{g} &:=
          \big\{
            v_{h} + g_{h}
          \big|
            v_{h}  \in {S_{h}^{k}}_g\komma
          \big\}
      \end{align}
      with ${g_{h} \in S_{h}^{k}}$ being the projection of $g$ onto ${S_{h}^{k}}$.
    ...
    \begin{definition}[Finite element solution]\theoremNewline
      ...
      \begin{align}
        \label{equation::introduction::finite_element_solution_0}
          A({u_{h}}_{0})[v_{h}] = F[v_{h}] &&\text{for all } v_{h} \in {S_{h}^{1}}_0\punkt
      \end{align}
      The finite element solution of \eqref{equation::introduction::elliptic_pde} is then given as
      \begin{align}
