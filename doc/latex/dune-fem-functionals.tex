...
\begin{document}
  ...
  \section{Introduction}
    ...
    written as the following variational problem.
    ...
    In order to solve the above problem we can rewrite equation
    \eqref{equation::introduction::variational_formulation_functionals_operators} using the fact that the desired
    solution lies in the affine subspace ${H_{g}^{1}}$ and can thus be decomposed as ${u = u_0 + \hat{g}}$.
    ...
    In order to solve equation \eqref{equation::introduction::variational_formulation_functionals_operators} numerically
    ...
    \begin{definition}[finite element discretization]\theoremNewline
      ...
      With the notation from example \ref{example::introduction::elliptic_pde}, let $\Tau_h$ be a conform admissable
    ...
    \begin{definition}[finite element solution]\theoremNewline
      ...
      With the notation from remark \ref{remark::introduction::variational_formulation_functionals_operators} and
    ...
    \begin{remark}[Solver]\theoremNewline
      ...
      \begin{itemize}
        ...
        \item the solver assembles the displacement vector $A(\hat{g},\psi_j)$ and substracts it
