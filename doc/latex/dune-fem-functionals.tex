...
\begin{itemize}
  ...
  \item[$\circ$] incorporates something like:\\
\CodeT{assembleFunctional(); constraints.apply( functional );} 
\end{itemize}
...
// behaves like the old Operator-class of dunefem:
...
AssembledFunctionalType rhsFunctional ( disceretFunctionSpace, functional );
