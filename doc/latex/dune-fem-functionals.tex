...
\begin{document}
  ...
  \section{Abstract concept}
    ...
    \begin{lemma}[Localization property of discrete linear functionals]\theoremNewline
      ...
      \end{align}
      the representation for a local function in terms of its local DoFs $u_i^E$ and the local
      ...
      \begin{align}
        u &= \sum\limits_{E \in G}
          ...
          \notag
      \end{align}
      where ${\mu_G}$ is local--to--global DoF mapping. Since $f$ if a discrete linear functional, it holds that
      \begin{align}
      ...
      \end{align}
      where $u^E := ( u_{\mu_G(i)}^E )_{i \in I_E}$ is the local DoF vector of $u$ on $E$ (mapped to global) and
  ...
  \section{Realization in \dunefemfunctionals}
    ...
    \subsection{Functionals}
      ...
      \begin{class}[\CodeT{DiscreteFunctional}]\theoremNewline
        This class represents a functional $F$ (see definition \ref{definition::analytical_concept::functional}),
        ...
        \begin{tabular}{l}
          ...
          \hline
          \hline
          \codeT{RangeFieldType ret = operator( DiscreteFunctionType discreteFunction )}\\
          \begin{tabular}{l|l}
            description:
              & This method represents the functional, applied to a function.\\
            \hline
      ...
      \begin{class}[\CodeT{DiscreteCombinedFunctional}]\theoremNewline
        ...
        \begin{tabular}{l}
          ...
          \hline
          \hline
          \codeT{class DiscreteCombinedFunctional< FirstFunctionalType, SecondFunctionalType >}\\
          \codeT{: Functional}
        \end{tabular}\\\\\\
        \noindent
        \begin{tabular}{l}
