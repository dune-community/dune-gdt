...
before_script:
    ...
    - printenv | \grep TEST >> ${ENV_FILE}|| echo This is not a failure
...
{%- for tag in docker_tags %}
  - stage: test_python
    env: DOCKER_TAG={{tag}}
    script: ${DOCKER_RUN} /root/src/dune-gdt/.travis.test_python.bash
...
with open(ymlfn, 'wt') as yml:
    yml.write(tpl.render(builders=range(0, builder_count), docker_tags=['clang', 'gcc']))
