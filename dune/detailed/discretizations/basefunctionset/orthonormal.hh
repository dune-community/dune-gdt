...
public:
  ...
  typedef Orthonormal< DiscreteFunctionSpaceType >
    ThisType;
  ...
  typedef Dune::Detailed::Discretizations::BaseFunctionSet::Local::Orthonormal< ThisType >
    LocalBaseFunctionSetType;

private:
  typedef Dune::OrthonormalLocalFiniteElement< GridViewType::dimension, DomainType, RangeType >
    LocalFiniteElementType;

  typedef typename LocalFiniteElementType::Traits::LocalBasisType
...
private:
  ...
  friend class Dune::Detailed::Discretizations::BaseFunctionSet::Local::Orthonormal< ThisType >;
