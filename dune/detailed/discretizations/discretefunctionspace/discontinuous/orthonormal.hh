...
public:
  ...
  typedef Orthonormal<FunctionSpaceType, GridViewType, polynomialOrder> ThisType;

  typedef Dune::Detailed::Discretizations::Mapper::Discontinuous<ThisType> MapperType;

  typedef Dune::Detailed::Discretizations::BaseFunctionSet::Orthonormal<ThisType> BaseFunctionSetType;
  ...
  /**
      ...
      @{
   **/
  typedef typename GridViewType::template Codim<0>::Iterator GridElementIteratorType;

  typedef typename GridElementIteratorType::Entity GridElementType;
  /**
      @}
   **/
