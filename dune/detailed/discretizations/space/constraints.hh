...
public:
  LocalConstraints(const size_t numRows,
...
public:
  ...
  LocalConstraints< typename SpaceInterface< T >::RangeFieldType > local(const SpaceInterface< T >& testSpace,
...
class NoConstraints
  : public ConstraintsInterface< NoConstraintsTraits >
{
public:
