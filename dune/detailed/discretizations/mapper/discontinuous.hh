...
public:
  ...
  typedef Discontinuous<DiscreteFunctionSpaceType> ThisType;

  typedef typename DiscreteFunctionSpaceType::GridViewType::IndexSet IndexSetType;
  ...
  {
    //    std::cout << indexSet_.index(entity) << ", " << localDofNumber << ": " <<
    //    indexSet_.index(entity)*maxLocalSize() + localDofNumber << std::endl;
