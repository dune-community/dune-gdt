...
class Multiscale< Dune::grid::Multiscale::Default< GridImp >,
                  Dune::Detailed::Discretizations::DiscreteFunction::DefaultConst< LocalDiscreteFunctionSpaceImp, LocalVectorBackendImp > >
  : public Dune::VTKFunction< typename Dune::grid::Multiscale::Default< GridImp >::GlobalGridViewType >
{
public:
  typedef Multiscale< Dune::grid::Multiscale::Default< GridImp >, Dune::Detailed::Discretizations::DiscreteFunction::DefaultConst< LocalDiscreteFunctionSpaceImp, LocalVectorBackendImp > > ThisType;

  typedef Dune::grid::Multiscale::Default< GridImp > MsGridType;

  typedef typename MsGridType::GlobalGridViewType GlobalGridViewType;

  typedef Dune::Detailed::Discretizations::DiscreteFunction::DefaultConst< LocalDiscreteFunctionSpaceImp, LocalVectorBackendImp > LocalDiscreteFunctionType;
...
const std::string Multiscale< Dune::grid::Multiscale::Default< GridType>, Dune::Detailed::Discretizations::DiscreteFunction::DefaultConst< LocalDiscreteFunctionSpaceType, LocalVectorBackendType > >::id = "detailed.discretizations.discretefunction.multiscale";
