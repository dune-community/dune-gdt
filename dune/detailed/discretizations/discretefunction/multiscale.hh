...
class Multiscale< Dune::grid::Multiscale::Default< GridImp >,
                  Dune::Detailed::Discretizations::DiscreteFunction::Default< LocalDiscreteFunctionSpaceImp, LocalVectorBackendImp > >
  : public Dune::VTKFunction< typename Dune::grid::Multiscale::Default< GridImp >::GlobalGridViewType >
{
public:
  typedef Multiscale< Dune::grid::Multiscale::Default< GridImp >, Dune::Detailed::Discretizations::DiscreteFunction::Default< LocalDiscreteFunctionSpaceImp, LocalVectorBackendImp > > ThisType;
...
const std::string Multiscale< Dune::grid::Multiscale::Default< GridType>, Dune::Detailed::Discretizations::DiscreteFunction::Default< LocalDiscreteFunctionSpaceType, LocalVectorBackendType > >::id = "detailed.discretizations.discretefunction.multiscale";
