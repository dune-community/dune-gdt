...
public:
  ...
  Default(const DiscreteFunctionSpaceType& _space, std::shared_ptr<VectorType> _vector,
...
template <class DiscreteFunctionSpaceImp, class VectorImp>
class DefaultConst : public Dune::VTKFunction<typename DiscreteFunctionSpaceImp::GridViewType>
{
private:
  typedef Dune::VTKFunction<typename DiscreteFunctionSpaceImp::GridViewType> BaseType;
...
public:
  ...
  DefaultConst(const DiscreteFunctionSpaceType& _space, const std::shared_ptr<const VectorType> _vector,
               const std::string _name = "discrete_function")
    : BaseType()
    , space_(_space)
    , name_(_name)
