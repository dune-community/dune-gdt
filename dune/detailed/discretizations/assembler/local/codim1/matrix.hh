...
{
public:
  typedef LocalInnerOperatorImp
    LocalInnerOperatorType;
...
//    LocalNeumannOperatorType;
  ...
  typedef Matrix< LocalInnerOperatorType/*, LocalDirichletOperatorType*//*, LocalNeumannOperatorType*/ >
    ThisType;

  typedef typename LocalInnerOperatorType::RangeFieldType
    RangeFieldType;
