      ...
      for (unsigned int j = 0; j < colsNeighbor; ++j) {
        ...
        }
        {
          ...
          const RangeType evaluationTimesNormalTimesGradient =
              localTestBaseFunctionSetNeighborEvaluations[j] * normalTimesGradient;
          entityNeighborRet[i][j] += 0.5 * functionValue * evaluationTimesNormalTimesGradient;
        }
        {
          const RangeFieldType evaluationTimesEvaluation =
              localTestBaseFunctionSetNeighborEvaluations[j] * localAnsatzBaseFunctionSetEntityEvaluations[i];
      ...
      for (unsigned int j = 0; j < colsEntity; ++j) {
        ...
        }
        {
          const RangeFieldType normalTimesGradient =
              unitOuterNormal * localAnsatzBaseFunctionSetNeighborGradients[i][0];
          const RangeType evaluationTimesNormalTimesGradient =
              localTestBaseFunctionSetEntityEvaluations[j] * normalTimesGradient;
        ...
        }
        {
          const RangeFieldType evaluationTimesEvalaution =
              localTestBaseFunctionSetEntityEvaluations[j] * localAnsatzBaseFunctionSetNeighborEvaluations[i];
      ...
      for (unsigned int j = 0; j < colsNeighbor; ++j) {
        {
          ...
          const RangeType gradientTimesNormalTimesEvalaution =
              localAnsatzBaseFunctionSetNeighborEvaluations[i] * gradientTimesNormal;
        ...
        {
          const RangeFieldType evaluationTimesEvaluation =
              localTestBaseFunctionSetNeighborEvaluations[j] * localAnsatzBaseFunctionSetNeighborEvaluations[i];
