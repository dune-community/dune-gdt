...
//  : public DiscreteFunctionSpaceDefault<  LagrangeDiscreteFunctionSpaceTraits<  typename
//  FunctionalsLagrangeSpaceImp::FunctionSpaceType,
//                                                                                typename
//                                                                                FunctionalsLagrangeSpaceImp::GridPartType,
//                                                                                FunctionalsLagrangeSpaceImp::polynomialOrder,
//                                                                                CachingStorage > >
{
public:
  typedef FunctionalsLagrangeSpaceImp HostSpaceType;
  ...
  typedef LagrangeDiscreteFunctionSpaceTraits<FunctionSpaceType, GridPartType, polynomialOrder, CachingStorage> Traits;

  typedef LagrangeDiscreteFunctionSpace<HostSpaceType> LagrangeDiscreteFunctionSpaceType;
