...
//! Contains various local operations.
namespace LocalOperation {

//! Contains various integrators.
...
class Codim0 : public Dune::Functionals::LocalOperation::Interface<FunctionSpaceImp>
{
public:
...
private:
  ...
  {
  public:
    typedef typename LocalTestFunctionType::DiscreteFunctionSpaceType DiscreteFunctionSpaceType;
    typedef typename LocalTestFunctionType::EntityType EntityType;
    typedef typename LocalTestFunctionType::RangeFieldType RangeFieldType;

    SingleFunctor(const LocalOperationType& localOperation, const LocalTestFunctionType& localTestFunction)
  ...
  {
  public:
    typedef typename LocalAnsatzFunctionType::DiscreteFunctionSpaceType DiscreteFunctionSpaceType;
    typedef typename LocalAnsatzFunctionType::EntityType EntityType;
    typedef typename LocalAnsatzFunctionType::RangeFieldType RangeFieldType;

    DoubleFunctor(const LocalOperationType& localOperation, const LocalAnsatzFunctionType& localAnsatzFunction,
...
public:
  ...
  {
    typedef SingleFunctor<LocalOperationType, LocalTestFunctionType> FunctorType;
  ...
  {
    typedef DoubleFunctor<LocalOperationType, LocalAnsatzFunctionType, LocalTestFunctionType> FunctorType;
...
private:
  ...
  const RangeFieldType integrate(const FunctorType& functor) const
  {
    ...
    typedef typename FunctorType::DiscreteFunctionSpaceType DiscreteFunctionSpaceType;

    typedef typename DiscreteFunctionSpaceType::GridPartType GridPartType;

    typedef typename FunctorType::EntityType EntityType;
