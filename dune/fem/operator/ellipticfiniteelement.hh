...
public:
  ...
  const RangeFieldType operator()(const DiscreteFucntionImp1& function1, const DiscreteFunctionImp2& function2) const
  {
    RangeFieldType ret = 0.0;

    // some types we will nedd
    typedef DiscreteFunctionImp1 DiscreteFunctionType1;
    typedef DiscreteFunctionImp2 DiscreteFunctionType2;
