#ifndef DUNE_FUNCTIONALS_BASEFUNCTIONSET_LOCAL_WRAPPER_HH
#define DUNE_FUNCTIONALS_BASEFUNCTIONSET_LOCAL_WRAPPER_HH
...
public:
  ...
  typedef Wrapper<LocalFunctionType> ThisType;
