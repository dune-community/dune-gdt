...
public:
  ...
  typedef InnerLocalOperatorImp
    InnerLocalOperatorType;

  typedef DirichletLocalOperatorImp
    DirichletLocalOperatorType;

  typedef NeumannLocalOperatorImp
    NeumannLocalOperatorType;

  typedef Matrix< InnerLocalOperatorType, DirichletLocalOperatorType, NeumannLocalOperatorType >
    ThisType;

  typedef typename InnerLocalOperatorType::RangeFieldType
    RangeFieldType;
...
//  };
  ...
  //! constructor
  Matrix( const InnerLocalOperatorType& innerLocalOperator,
          const DirichletLocalOperatorType& dirichletLocalOperator,
