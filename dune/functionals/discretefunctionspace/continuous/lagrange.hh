...
public:
  ...
  typedef Lagrange< FunctionSpaceType, GridViewType, polOrder >
    ThisType;
...
private:
  ...
  typedef Dune::PDELab::P1LocalFiniteElementMap< DomainFieldType, RangeFieldType, dimDomain >
    LocalFiniteElementMapType;
...
//    HostSpaceType;
  ...
  typedef Dune::PDELab::GridFunctionSpace< GridViewType, LocalFiniteElementMapType >
    HostSpaceType;

  typedef Dune::Functionals::Common::LocalBaseFunctionSet< ThisType >
    LocalBaseFunctionSetType;

  typedef typename GridViewType::template Codim< 0 >::Entity
    EntityType;
