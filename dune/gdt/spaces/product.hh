...
public:
  ...
  typedef typename Dune::GDT::BaseFunctionSet::ProductBaseFunctionSet< typename SpaceImps::BaseFunctionSetType... > BaseFunctionSetType;
...
class TaylorHoodSpace
    : public DefaultProductSpace< CG::PdelabBased< GridViewImp, polynomialOrder, RangeFieldImp, domainDim, 1 >, CG::PdelabBased< GridViewImp, polynomialOrder - 1, RangeFieldImp, 1, 1 >>
{
public:
