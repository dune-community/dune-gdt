...
private:
  ...
  const std::unique_ptr<XT::Functions::GridFunctionInterface<E, d, d>> diffusion_in_;
  const std::unique_ptr<XT::Functions::GridFunctionInterface<E, d, d>> diffusion_out_;
