...
public:
  ...
  {
    func_(this->source(), this->local_sources(), local_range, param);
  }
...
public:
  ...
  {
    func_(this->source(), this->local_sources(), this->intersection(), local_range_inside, local_range_outside, param);
  }
