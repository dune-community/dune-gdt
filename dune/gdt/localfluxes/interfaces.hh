...
class NumericalCouplingFluxInterface
    : public Stuff::CRTPInterface< NumericalCouplingFluxInterface< Traits >, Traits >
...
class NumericalBoundaryFluxInterface
    : public Stuff::CRTPInterface< NumericalBoundaryFluxInterface< Traits >, Traits >
 ...
 * */
template< class E, class D, size_t d, class R, size_t r, size_t rC = 1>
class RHSEvaluationInterface
    : internal::IsRHSEvaluation
{
  static_assert(rC == 1, "Not implemented for rC > 1");
public:
  typedef E EntityType;
...
template< class T >
struct is_numerical_coupling_flux
    : std::is_base_of< internal::IsNumericalCouplingFlux, T >
{};

template< class T >
struct is_numerical_boundary_flux
    : std::is_base_of< internal::IsNumericalBoundaryFlux, T >
{};

template< class T >
struct is_analytical_flux
    : std::is_base_of< internal::IsAnalyticalFlux, T >
{};

template< class T >
struct is_rhs_evaluation
    : std::is_base_of< internal::IsRHSEvaluation, T >
{};
