...
template <class AnalyticalCouplingFluxImp, size_t dimDomain>
bool GodunovNumericalCouplingFlux<AnalyticalCouplingFluxImp, dimDomain>::jacobians_constructed_(false);
...
thread_local typename GodunovNumericalCouplingFlux<AnalyticalCouplingFluxImp, 1>::FluxJacobianRangeType
    GodunovNumericalCouplingFlux<AnalyticalCouplingFluxImp, 1>::jacobian_neg_{
        typename GodunovNumericalCouplingFlux<AnalyticalCouplingFluxImp, 1>::FluxJacobianRangeType()};

template <class AnalyticalCouplingFluxImp>
thread_local typename GodunovNumericalCouplingFlux<AnalyticalCouplingFluxImp, 1>::FluxJacobianRangeType
    GodunovNumericalCouplingFlux<AnalyticalCouplingFluxImp, 1>::jacobian_pos_{
        typename GodunovNumericalCouplingFlux<AnalyticalCouplingFluxImp, 1>::FluxJacobianRangeType()};

template <class AnalyticalCouplingFluxImp>
thread_local typename GodunovNumericalCouplingFlux<AnalyticalCouplingFluxImp, 1>::FluxJacobianRangeType
    GodunovNumericalCouplingFlux<AnalyticalCouplingFluxImp, 1>::jacobian_abs_{
        typename GodunovNumericalCouplingFlux<AnalyticalCouplingFluxImp, 1>::FluxJacobianRangeType()};

template <class AnalyticalCouplingFluxImp>
thread_local typename GodunovNumericalCouplingFlux<AnalyticalCouplingFluxImp, 1>::AffineFunctionType
    GodunovNumericalCouplingFlux<AnalyticalCouplingFluxImp, 1>::jacobian_neg_function_(
        GodunovNumericalCouplingFlux<AnalyticalCouplingFluxImp, 1>::AffineFunctionType(
            GodunovNumericalCouplingFlux<AnalyticalCouplingFluxImp, 1>::FluxJacobianRangeType(0)));

template <class AnalyticalCouplingFluxImp>
thread_local typename GodunovNumericalCouplingFlux<AnalyticalCouplingFluxImp, 1>::AffineFunctionType
    GodunovNumericalCouplingFlux<AnalyticalCouplingFluxImp, 1>::jacobian_pos_function_(
        GodunovNumericalCouplingFlux<AnalyticalCouplingFluxImp, 1>::AffineFunctionType(
            GodunovNumericalCouplingFlux<AnalyticalCouplingFluxImp, 1>::FluxJacobianRangeType(0)));

template <class AnalyticalCouplingFluxImp>
thread_local typename GodunovNumericalCouplingFlux<AnalyticalCouplingFluxImp, 1>::AffineFunctionType
    GodunovNumericalCouplingFlux<AnalyticalCouplingFluxImp, 1>::jacobian_abs_function_(
        GodunovNumericalCouplingFlux<AnalyticalCouplingFluxImp, 1>::AffineFunctionType(
            GodunovNumericalCouplingFlux<AnalyticalCouplingFluxImp, 1>::FluxJacobianRangeType(0)));

template <class AnalyticalCouplingFluxImp>
thread_local bool GodunovNumericalCouplingFlux<AnalyticalCouplingFluxImp, 1>::jacobians_constructed_(false);
...
public:
                      ...
                      const Dune::FieldVector<DomainFieldType, dimDomain - 1>& x_intersection) const
  {
    ...
    const RangeType u_i =
        local_source_entity.evaluate(intersection.geometryInInside().global(x_intersection_entity_coords));
