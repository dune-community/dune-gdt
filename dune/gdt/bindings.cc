...
template <class SP>
void
addbind_for_space(py::module& m, const std::string& grid_id, const std::string& space_id, const std::string& backend)
{
...
template <class G>
void
addbind_for_grid(py::module& m, const std::string& grid_id)
{
  // FV
