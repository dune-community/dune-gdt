...
public:
   ...
   *  \attention ret is assumed to be zero!
   */
  template <class LocalFunctionTuple, class E, class IntersectionType, class D, int d, class R, int rT, int rCT, int rA,
            int rCA>
  void evaluate(const LocalFunctionTuple& localFunctions,
                const Stuff::LocalfunctionSetInterface<E, D, d, R, rT, rCT>& testBase,
                const Stuff::LocalfunctionSetInterface<E, D, d, R, rA, rCA>& ansatzBase,
...
public:
   ...
   *  \tparam rC{T,A}               dimRangeRows of the {testBase*,ansatzBase*}
   */
  template <class LocalFunctionTupleEn, class LocalFunctionTupleNe, class E, class N, class D, int d, class R, int rT,
            int rCT, int rA, int rCA>
  size_t order(const LocalFunctionTupleEn& localFunctionsEntity, const LocalFunctionTupleNe& localFunctionsNeighbor,
   ...
   */
  template <class LocalFunctionTupleEn, class LocalFunctionTupleNe, class E, class N, class IntersectionType, class D,
