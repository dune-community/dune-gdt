...
private:
  ...
  struct Helper { static_assert(AlwaysFalse< DiffusionTensorImp >::value, "Unsupported combination of functions given!"); };
...
public:
  ...
  Elliptic(const DiffusionFactorType& diffusion_factor)
    : diffusion_factor_(diffusion_factor)
    , diffusion_tensor_(new DiffusionTensorType(Stuff::Functions::internal::UnitMatrix< typename DiffusionTensorType::RangeFieldType, dimDomain >::value()))
  {}
