...
public:
  ...
  order(const Stuff::LocalfunctionInterface< EntityType, DomainFieldType, dimDomain, R, 1 >& local_diffusion_factor_en,
  ...
  order(const Stuff::LocalfunctionInterface< EntityType, DomainFieldType, dimDomain, R, dimDomain, dimDomain >& local_diffusion_tensor_en,
  ...
  evaluate(const Stuff::LocalfunctionInterface< EntityType, DomainFieldType, dimDomain, R, 1, 1 >& local_diffusion_factor_en,
  ...
  evaluate(const Stuff::LocalfunctionInterface< EntityType, DomainFieldType, dimDomain, R, dimDomain, dimDomain >& local_diffusion_tensor_en,
           const Stuff::LocalfunctionInterface< EntityType, DomainFieldType, dimDomain, R, dimDomain, dimDomain >& local_diffusion_tensor_ne,
           const Stuff::LocalfunctionSetInterface< EntityType, DomainFieldType, dimDomain, R, 1, 1 >& test_base_en,
           const Stuff::LocalfunctionSetInterface< EntityType, DomainFieldType, dimDomain, R, 1, 1 >& ansatz_base_en,
           const Stuff::LocalfunctionSetInterface< EntityType, DomainFieldType, dimDomain, R, 1, 1 >& test_base_ne,
...
public:
  ...
  template< class R, size_t rT, size_t rCT, size_t rA, size_t rCA >
    typename std::enable_if< std::is_same< DiffusionTensorImp, void >::value && dimDomain != 1, size_t >::type
  order(const Stuff::LocalfunctionInterface< EntityType, DomainFieldType, dimDomain, R, dimDomain, dimDomain >& local_diffusion_tensor,
        const Stuff::LocalfunctionSetInterface< EntityType, DomainFieldType, dimDomain, R, rT, rCT >& test_base,
        const Stuff::LocalfunctionSetInterface< EntityType, DomainFieldType, dimDomain, R, rA, rCA >& ansatz_base) const
  {
           ...
           Dune::DynamicMatrix< R >& ret) const
  {
    const auto local_functions = localFunctions(local_diffusion_factor.entity());
    const auto local_diffusion_tensor = std::get< 1 >(local_functions);
    evaluate(local_diffusion_factor, *local_diffusion_tensor,
  ...
  template< class R, class IntersectionType >
      typename std::enable_if< std::is_same< DiffusionTensorImp, void >::value && dimDomain != 1, void >::type
  evaluate(const Stuff::LocalfunctionInterface< EntityType, DomainFieldType, dimDomain, R, dimDomain, dimDomain >& local_diffusion_tensor,
           const Stuff::LocalfunctionSetInterface< EntityType, DomainFieldType, dimDomain, R, 1, 1 >& test_base,
           const Stuff::LocalfunctionSetInterface< EntityType, DomainFieldType, dimDomain, R, 1, 1 >& ansatz_base,
           const IntersectionType& intersection,
           const Dune::FieldVector< DomainFieldType, dimDomain - 1 >& local_point,
...
class BoundaryRHS
  : public LocalEvaluation::Codim1Interface
        < internal::BoundaryRHSTraits< DirichletImp, DiffusionFactorImp, DiffusionTensorImp >, 1 >
{
  typedef Elliptic< DiffusionFactorImp, DiffusionTensorImp >                  EllipticType;
