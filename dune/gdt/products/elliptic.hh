...
template <class DiffusionImp, class GridViewImp, class RangeImp, class SourceImp, class FieldImp>
class EllipticLocalizable : public Products::LocalizableBase<EllipticLocalizableTraits<DiffusionImp, GridViewImp,
...
template <class DiffusionImp, class MatrixImp, class RangeSpaceImp, class GridViewImp, class SourceSpaceImp>
class EllipticAssemblable
    : public Products::AssemblableBase<EllipticAssemblableTraits<DiffusionImp, MatrixImp, RangeSpaceImp, GridViewImp,
                                                                 SourceSpaceImp>>,
      public EllipticBase<DiffusionImp, GridViewImp, typename MatrixImp::ScalarType>
{
  typedef Products::AssemblableBase<EllipticAssemblableTraits<DiffusionImp, MatrixImp, RangeSpaceImp, GridViewImp,
