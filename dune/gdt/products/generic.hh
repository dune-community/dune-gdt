...
class GenericLocalizable
  : public LocalizableBase< TraitsTemplate< GridViewImp, RangeImp, SourceImp,
                   GenericLocalizable<GridViewImp, RangeImp, SourceImp, TraitsTemplate, LocalEvaluationTemplate>
...
class GenericAssemblable
  : public AssemblableBase< TraitsTemplate< MatrixImp, RangeSpaceImp, GridViewImp, SourceSpaceImp,
                                           GenericAssemblable<MatrixImp, RangeSpaceImp, GridViewImp,
...
{
  typedef GenericAssemblable<MatrixImp, RangeSpaceImp, GridViewImp,
...
public:
  ...
  GenericAssemblable(MatrixType& mtrx,
  ...
  GenericAssemblable(MatrixType& matrix,
...
class GenericProduct
  : public ProductInterface< internal::DerivedType<GridViewImp, FieldImp, GenericProduct<GridViewImp, FieldImp, OperatorTemplate > > >
{
public:
  typedef internal::DerivedType<GridViewImp, FieldImp,
                                GenericProduct<GridViewImp, FieldImp, OperatorTemplate > > Traits;
