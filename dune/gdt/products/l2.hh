...
class LocalizableForward
    : public LocalizableBase<TraitsTemplate<GridViewImp, RangeImp, SourceImp,
                                            LocalizableForward<GridViewImp, RangeImp, SourceImp, TraitsTemplate,
...
template <class GridViewImp, class RangeImp, class SourceImp>
using L2Localizable =
    LocalizableForward<GridViewImp, RangeImp, SourceImp, internal::L2LocalizableTraits, LocalEvaluation::Product>;
...
class AssemblableForward
    : public AssemblableBase<TraitsTemplate<MatrixImp, RangeSpaceImp, GridViewImp, SourceSpaceImp,
                                            AssemblableForward<MatrixImp, RangeSpaceImp, GridViewImp, SourceSpaceImp,
...
{
  typedef AssemblableForward<MatrixImp, RangeSpaceImp, GridViewImp, SourceSpaceImp, TraitsTemplate,
...
class ProductForward
    : public ProductInterface<internal::DerivedType<GridViewImp, FieldImp,
                                                    ProductForward<GridViewImp, FieldImp, OperatorTemplate>>>
{
public:
  typedef internal::DerivedType<GridViewImp, FieldImp, ProductForward<GridViewImp, FieldImp, OperatorTemplate>> Traits;
