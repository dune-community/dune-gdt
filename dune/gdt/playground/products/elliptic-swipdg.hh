...
class EllipticSWIPDGPenalty
  : public LocalizableProductInterface< internal::EllipticSWIPDGPenaltyTraits< GridViewImp, DiffusionFactorImp, RangeImp, SourceImp, FieldImp, DiffusionTensorImp > >
  , public Stuff::Grid::Functor::Codim1< GridViewImp >
{
  typedef LocalizableProductInterface< internal::EllipticSWIPDGPenaltyTraits
...
public:
  typedef internal::EllipticSWIPDGPenaltyTraits
...
public:
  EllipticSWIPDGPenalty(const GridViewType& grd_vw,
                        const RangeType& rng,
