...
public:
  EllipticBase(const DiffusionFactorType& diffusion_factor,
...
{
public:
  typedef EllipticAssemblable
      < DiffusionFactorType, MatrixImp, RangeSpaceImp, GridViewImp, SourceSpaceImp, DiffusionTensorType > derived_type;
...
class EllipticLocalizable
  : public Products::LocalizableBase< internal::EllipticLocalizableTraits< DiffusionFactorType, GridViewImp, RangeImp, SourceImp, FieldImp, DiffusionTensorType > >
  , public internal::EllipticBase< DiffusionFactorType, GridViewImp, FieldImp, DiffusionTensorType >
{
  typedef Products::LocalizableBase
      < internal::EllipticLocalizableTraits< DiffusionFactorType, GridViewImp, RangeImp, SourceImp, FieldImp, DiffusionTensorType > >
    LocalizableBaseType;
  typedef internal::EllipticBase< DiffusionFactorType, GridViewImp, FieldImp, DiffusionTensorType > EllipticBaseType;
public:
  typedef internal::EllipticLocalizableTraits< DiffusionFactorType, GridViewImp, RangeImp, SourceImp, FieldImp, DiffusionTensorType > Traits;
...
public:
  EllipticLocalizable(const DiffusionFactorType& diffusion_factor,
                      const DiffusionTensorType& diffusion_tensor,
...
template< class DiffusionFactorType, class MatrixImp, class RangeSpaceImp, class GridViewImp, class SourceSpaceImp, class DiffusionTensorType >
class EllipticAssemblable
  : public Products::AssemblableBase< internal::EllipticAssemblableTraits< DiffusionFactorType, MatrixImp, RangeSpaceImp, GridViewImp, SourceSpaceImp, DiffusionTensorType > >
  , public internal::EllipticBase< DiffusionFactorType, GridViewImp, typename MatrixImp::ScalarType, DiffusionTensorType >
{
  typedef Products::AssemblableBase
      < internal::EllipticAssemblableTraits< DiffusionFactorType, MatrixImp, RangeSpaceImp, GridViewImp, SourceSpaceImp, DiffusionTensorType > >
    AssemblableBaseType;
  typedef internal::EllipticBase< DiffusionFactorType, GridViewImp, typename MatrixImp::ScalarType, DiffusionTensorType > EllipticBaseType;
public:
  typedef internal::EllipticAssemblableTraits< DiffusionFactorType, MatrixImp, RangeSpaceImp, GridViewImp, SourceSpaceImp, DiffusionTensorType >
    Traits;
  typedef typename Traits::GridViewType     GridViewType;
...
public:
  ...
  EllipticAssemblable(const DiffusionFactorType& diffusion_factor,
                      const DiffusionTensorType& diffusion_tensor,
                      MatrixType& matrix,
