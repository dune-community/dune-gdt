...
template <class GridViewImp, class DiffusionFactorType, class DiffusiveFluxType, class RangeImp, class SourceImp,
...
template <class GridViewImp, class DiffusionFactorType, class DiffusiveFluxType, class RangeImp, class SourceImp,
          class FieldImp, class DiffusionTensorType = void>
class DiffusiveFluxEstimateTraits
{
public:
  typedef DiffusiveFluxEstimate<GridViewImp, DiffusionFactorType, DiffusiveFluxType, RangeImp, SourceImp, FieldImp,
...
private:
  typedef LocalEvaluation::ESV2007::DiffusiveFluxEstimate<DiffusionFactorType, DiffusiveFluxType, DiffusionTensorType>
      LocalEvalautionType;
...
template <class GridViewImp, class DiffusionType, class DiffusiveFluxType, class RangeImp, class SourceImp,
          class FieldImp>
...
class DiffusiveFluxEstimate<GridViewImp, DiffusionType, DiffusiveFluxType, RangeImp, SourceImp, FieldImp, void>
    : public Products::LocalizableBase<internal::DiffusiveFluxEstimateTraits<GridViewImp, DiffusionType,
                                                                             DiffusiveFluxType, RangeImp, SourceImp,
                                                                             FieldImp>>
{
  typedef Products::LocalizableBase<internal::DiffusiveFluxEstimateTraits<GridViewImp, DiffusionType, DiffusiveFluxType,
                                                                          RangeImp, SourceImp, FieldImp>> BaseType;

public:
  typedef internal::DiffusiveFluxEstimateTraits<GridViewImp, DiffusionType, DiffusiveFluxType, RangeImp, SourceImp,
                                                FieldImp> Traits;
...
template <class GridViewImp, class DiffusionFactorType, class DiffusiveFluxType, class RangeImp, class SourceImp,
          class FieldImp, class DiffusionTensorType>
class DiffusiveFluxEstimate
    : public Products::LocalizableBase<internal::DiffusiveFluxEstimateTraits<GridViewImp, DiffusionFactorType,
                                                                             DiffusiveFluxType, RangeImp, SourceImp,
                                                                             FieldImp, DiffusionTensorType>>
{
  typedef Products::LocalizableBase<internal::DiffusiveFluxEstimateTraits<GridViewImp, DiffusionFactorType,
                                                                          DiffusiveFluxType, RangeImp, SourceImp,
                                                                          FieldImp, DiffusionTensorType>> BaseType;

public:
  typedef internal::DiffusiveFluxEstimateTraits<GridViewImp, DiffusionFactorType, DiffusiveFluxType, RangeImp,
                                                SourceImp, FieldImp, DiffusionTensorType> Traits;
  using typename BaseType::GridViewType;
  using typename BaseType::RangeType;
  using typename BaseType::SourceType;
  typedef typename Traits::LocalOperatorType LocalOperatorType;
