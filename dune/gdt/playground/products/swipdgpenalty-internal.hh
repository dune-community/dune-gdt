...
class SwipdgPenaltyBase : public LocalOperatorProviderBase<GV>
{
...
public:
  ...
  typedef LocalOperator::Codim1CouplingIntegral<LocalEvaluation::SWIPDG::InnerPenalty<FunctionType, TensorType>>
      CouplingOperatorType;
  typedef LocalOperator::Codim1BoundaryIntegral<LocalEvaluation::SWIPDG::BoundaryLHSPenalty<FunctionType, TensorType>>
