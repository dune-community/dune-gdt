 ...
 * \todo  Add more documentation, especially a mathematical definition.
 */
template <class M, class F, class T, class R, class GV = typename R::GridViewType, class S = R,
          class FieldType = double>
class SwipdgPenaltyAssemblable : public AssemblableBase<internal::SwipdgPenaltyBase<GV, F, T, FieldType>, M, R, S>
{
...
class SwipdgPenalty : public GenericBase<internal::SwipdgPenaltyBase<GV, F, T, FieldType>>
{
