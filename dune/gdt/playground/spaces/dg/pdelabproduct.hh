...
class PdelabBasedProduct< GridViewImp, polynomialOrder, RangeFieldImp, rangeDim, 1 >
  : public Dune::GDT::SpaceInterface< internal::PdelabBasedProductTraits< GridViewImp, polynomialOrder, RangeFieldImp, rangeDim, 1 >, GridViewImp::dimension, rangeDim, 1 >
  , public Dune::GDT::ProductSpaceInterface< internal::PdelabBasedProductTraits< GridViewImp, polynomialOrder, RangeFieldImp, rangeDim, 1 >, GridViewImp::dimension, rangeDim, 1 >
{
  ...
  typedef typename Dune::GDT::SpaceInterface< internal::PdelabBasedProductTraits< GridViewImp, polynomialOrder, RangeFieldImp, rangeDim, 1 >, GridViewImp::dimension, rangeDim, 1 >  BaseType;
public:
