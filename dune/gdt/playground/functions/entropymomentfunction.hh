...
template< class GlobalfunctionType, class LocalizableFunctionType >
class Composition
  : public LocalizableFunctionInterface< typename LocalizableFunctionType::EntityType,
                                         ...
                                         GlobalfunctionType::dimRangeCols >
{
  typedef LocalizableFunctionInterface< typename LocalizableFunctionType::EntityType,
                                        typename LocalizableFunctionType::DomainFieldType,
                                        LocalizableFunctionType::dimDomain,
                                        typename GlobalfunctionType::RangeFieldType,
                                        GlobalfunctionType::dimRange,
                                        GlobalfunctionType::dimRangeCols >                         BaseType;
  typedef Composition< GlobalfunctionType, LocalizableFunctionType >                               ThisType;
public:
...
private:
  ...
  public:
    Localfunction(const EntityType& entity,
                  const LocalizableFunctionType& localizable_function,
                  const GlobalfunctionType& global_function)
      : BaseType(entity)
  ...
  private:
    const LocalizableFunctionType& localizable_function_;
...
//            cfg.get("name", default_cfg.get< std::string > ("name")));
  ...
  Composition(const GlobalfunctionType global_func,
              const LocalizableFunctionType local_func,
              const std::string nm = static_id())
    : global_function_(global_func)
    , local_function_(local_func)
    , name_(nm)
  {}
  ...
  {
     return DSC::make_unique< Localfunction >(entity, local_function_, global_function_);
  } // ... local_function(...)

private:
  const GlobalfunctionType global_function_;
  const LocalizableFunctionType local_function_;
  std::string name_;
}; // class Checkerboard
