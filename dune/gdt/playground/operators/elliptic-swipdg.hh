  ...
  , public SystemAssembler< RangeSpaceImp, GridViewImp, SourceSpaceImp >
{
  ...
  typedef LocalOperator::Codim0Integral< LocalEvaluation::Elliptic< DiffusionFactorType, DiffusionTensorType > >
      VolumeOperatorType;
  typedef LocalAssembler::Codim0Matrix< VolumeOperatorType >
      VolumeAssemblerType;
  ...
  typedef LocalAssembler::Codim1BoundaryMatrix< DirichletBoundaryOperatorType >
      DirichletBoundaryAssemblerType;

  typedef typename MatrixImp::ScalarType ScalarType;

public:
  typedef internal::EllipticSWIPDGTraits< DiffusionFactorType, MatrixImp, SourceSpaceImp
                                        , RangeSpaceImp, GridViewImp, DiffusionTensorType > Traits;
...
private:
  void setup()
  {
    ...
    this->add(coupling_assembler_, this->matrix(), new Stuff::Grid::ApplyOn::InnerIntersectionsPrimally< GridViewType >());
