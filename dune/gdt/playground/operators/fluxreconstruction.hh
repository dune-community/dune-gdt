...
public:
             ...
             DiscreteFunction< Spaces::RT::PdelabBased< GV, 0, FieldType, dimDomain >, V >& range) const
  {
    ...
    const LocalEvaluation::EllipticIpdg::Inner< DiffusionFactorType, DiffusionTensorType >
        inner_evaluation(diffusion_factor_, diffusion_tensor_);
    const LocalEvaluation::EllipticIpdg::BoundaryLHS< DiffusionFactorType, DiffusionTensorType >
