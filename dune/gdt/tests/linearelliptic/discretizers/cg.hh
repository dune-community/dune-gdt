...
public:
                                       ...
                                       const ProblemType& problem, const int level = 0)
  {
    ...
    auto elliptic_operator =
        Operators::make_elliptic_cg<MatrixType>(problem.diffusion_factor(), problem.diffusion_tensor(), space);
    ...
    auto dirichlet_projection = Operators::make_localizable_dirichlet_projection(
        space.grid_view(), *boundary_info, problem.dirichlet(), dirichlet_function);
