...
class L2Localizable : public Product::LocalizableBase<L2LocalizableTraits<GridViewImp, RangeImp, SourceImp, FieldImp>>,
...
{
  typedef Product::AssemblableBase<L2AssemblableTraits<MatrixImp, RangeSpaceImp, GridViewImp, SourceSpaceImp>> BaseType;
...
public:
  ...
  L2Assemblable(MatrixType& matrix, const RangeSpaceType& range_space)
