...
{
  typedef typename internal::L2ProlongationLocalizableOperatorTraits< GridViewImp, SourceImp, RangeImp >::BaseType BaseType;
public:
  template< class ...Args >
...
template< class GridViewType, class SS, class SV, class RS, class RV >
    typename std::enable_if< Stuff::Grid::is_grid_layer< GridViewType >::value
                           , std::unique_ptr< L2ProlongationLocalizableOperator< GridViewType,
                                                                                 ConstDiscreteFunction< SS, SV >,
                                                                                 DiscreteFunction< RS, RV > > >
                           >::type
make_l2_prolongation_localizable_operator(const GridViewType& grid_view,
                                          const ConstDiscreteFunction< SS, SV >& source,
                                          DiscreteFunction< RS, RV >& range,
                                          const size_t over_integrate = 0)
{
  return DSC::make_unique<
      L2ProlongationLocalizableOperator< GridViewType,
                                         ConstDiscreteFunction< SS, SV >,
                                         DiscreteFunction< RS, RV > > >(over_integrate,
                                                                        grid_view,
                                                                        source,
                                                                        range);
...
template< class SS, class SV, class RS, class RV >
  std::unique_ptr< L2ProlongationLocalizableOperator< typename RS::GridViewType,
                                                      ConstDiscreteFunction< SS, SV >,
                                                      DiscreteFunction< RS, RV > > >
...
{
  return DSC::make_unique<
      L2ProlongationLocalizableOperator< typename RS::GridViewType,
                                         ConstDiscreteFunction< SS, SV >,
                                         DiscreteFunction< RS, RV > > >(over_integrate,
...
class L2ProlongationOperator
  : public OperatorInterface< internal::L2ProlongationOperatorTraits< GridViewImp, FieldImp > >
{
...
private:
  ...
  struct redirect {
    ...
    {
      L2GlobalProlongationLocalizableOperator< GridViewType, SourceType, RangeType >(over_integrate, grd_vw,
                                                                                     src, rng).apply();
    }
  };
  ...
  struct redirect< false, anything > {
    ...
    static void apply(const GridViewType& grd_vw, const SourceType& src, RangeType& rng, const size_t over_integrate)
    {
      L2LocalProlongationLocalizableOperator< GridViewType, SourceType, RangeType >(over_integrate, grd_vw,
                                                                                    src, rng).apply();
    }
  };
...
template< class GridViewType >
    typename std::enable_if< Stuff::Grid::is_grid_layer< GridViewType >::value
                           , std::unique_ptr< L2ProlongationOperator< GridViewType > >
                           >::type
...
prolong_l2(const GridViewType& grid_view,
           const ConstDiscreteFunction< SS, SV >& source,
           DiscreteFunction< RS, RV >& range,
           const size_t over_integrate = 0)
{
