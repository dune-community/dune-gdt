...
struct DynamicTupleGetter
{
  ...
  static typename std::enable_if<I == sizeof...(TupleArgs), void>::type
  evaluate(const std::tuple< TupleArgs... >& /*tuple*/, const DomainType& /*xx*/, std::vector< RangeType >& /*ret*/, const size_t /*first_basis_func_index*/ = 0, const size_t /*first_range_index*/ = 0)
  {}
  ...
  evaluate(const std::tuple< TupleArgs... >& tuple, const DomainType& xx, std::vector< RangeType >& ret, const size_t first_basis_func_index = 0, const size_t first_range_index = 0)
  {
    ...
    DynamicTupleGetter< I + 1 >::evaluate(tuple, xx, ret, first_basis_func_index + num_basis_funcs_in_factor, first_range_index + dimRangeFactor);
  }

  template< class DomainType, class JacobianRangeType, typename... TupleArgs >
  static typename std::enable_if<I == sizeof...(TupleArgs), void>::type
  jacobian(const std::tuple< TupleArgs... >& /*tuple*/, const DomainType& /*xx*/, std::vector< JacobianRangeType >& /*ret*/, const size_t /*first_basis_func_index*/ = 0, const size_t /*first_range_index*/ = 0)
  {}
  ...
  jacobian(const std::tuple< TupleArgs... >& tuple, const DomainType& xx, std::vector< JacobianRangeType >& ret, const size_t first_basis_func_index = 0, const size_t first_range_index = 0)
  {
    ...
    DynamicTupleGetter< I + 1 >::jacobian(tuple, xx, ret, first_basis_func_index + num_basis_funcs_in_factor, first_range_index + dimRangeFactor);
  }
};
