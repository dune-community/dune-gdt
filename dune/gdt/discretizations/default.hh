...
template< class TestCaseImp, class FVSpaceImp, bool use_lax_friedrichs_flux, bool use_adaptive_timestepper, bool use_linear_reconstruction >
class NonStationaryDefaultTraits
{
  // no checks of the arguments needed, those are done in the interfaces
public:
  typedef NonStationaryDefault< TestCaseImp, FVSpaceImp, use_lax_friedrichs_flux, use_adaptive_timestepper, use_linear_reconstruction > derived_type;
...
class NonStationaryDefault
  : public NonStationaryDiscretizationInterface<
             internal::NonStationaryDefaultTraits< TestCaseImp, FVSpaceImp, use_lax_friedrichs_flux, use_adaptive_timestepper, use_linear_reconstruction > >
{
  typedef NonStationaryDiscretizationInterface
          < internal::NonStationaryDefaultTraits< TestCaseImp, FVSpaceImp, use_lax_friedrichs_flux, use_adaptive_timestepper, use_linear_reconstruction > >
      BaseType;
  typedef NonStationaryDefault< TestCaseImp, FVSpaceImp, use_lax_friedrichs_flux, use_adaptive_timestepper, use_linear_reconstruction > ThisType;
public:
  ...
  NonStationaryDefault(const TestCaseImp& tst_cs,
