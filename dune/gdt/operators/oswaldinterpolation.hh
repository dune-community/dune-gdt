...
public:
  ...
  void apply(
      const ConstDiscreteFunction<Spaces::DiscontinuousLagrange::FemLocalfunctionsBased<SGP, 1, FieldType, 1, 1>, SV>&
          source,
      DiscreteFunction<Spaces::DiscontinuousLagrange::FemLocalfunctionsBased<RGP, 1, FieldType, 1, 1>, RV>& range) const
  {
  ...
  template <class SGP, class SV, class RGP, class RV>
  void apply(
      const ConstDiscreteFunction<Spaces::Block<Spaces::DiscontinuousLagrange::FemLocalfunctionsBased<SGP, 1, FieldType,
                                                                                                      1, 1>>,
                                  SV>& source,
      DiscreteFunction<Spaces::Block<Spaces::DiscontinuousLagrange::FemLocalfunctionsBased<RGP, 1, FieldType, 1, 1>>,
                       RV>& range) const
  {
