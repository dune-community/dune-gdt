...
std::unique_ptr< EllipticSWIPDG< DF, M, S, S, typename S::GridViewType > > make_elliptic_swipdg(const DF& diffusion_factor,
                                                                                                const Stuff::Grid::BoundaryInfoInterface< typename S::GridViewType::Intersection >& boundary_info,
                                                                                                const M& /*matrix*/,
                                                                                                const S& space)
{
  return Stuff::Common::make_unique< EllipticSWIPDG< DF, M, S, S, typename S::GridViewType > >(diffusion_factor,
                                                                                               boundary_info,
                                                                                               space);
