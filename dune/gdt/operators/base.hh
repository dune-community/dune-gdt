...
class AssemblableVolumeBase : public AssemblableOperatorInterface<Traits>,
...
public:
  ...
  AssemblableVolumeBase(MatrixType& matrix, const SourceSpaceType& source_space, const RangeSpaceType& range_space,
  ...
  AssemblableVolumeBase(MatrixType& matrix, const SourceSpaceType& source_space)
    : matrix_(matrix)
    , source_space_(source_space)
...
public:
  ...
  virtual void apply_local(const EntityType& entity)
  {
    ...
    local_assembler_->assembleLocal(
        range_space_, source_space_, entity, matrix(), tmp_storage_->matrices(), tmp_storage_->indices());
  } // ... apply_local(...)
