  ...
  : public LocalizableProductDefault< GridView, Range, Source, Field >
{
  ...
  typedef LocalVolumeIntegralOperator
      < LocalEvaluation::Product< WeightFunctionType > > LocalWeightedL2OperatorType;
public:
  template< class ...Args >
...
template< class WeightFunctionType, class GridViewType, class RangeType, class SourceType >
    typename std::enable_if<    Stuff::is_localizable_function< WeightFunctionType >::value
                            ...
                            , std::unique_ptr< WeightedL2LocalizableProduct< WeightFunctionType, GridViewType,
...
template< class MatrixType, class WeightFunctionType, class SpaceType >
    typename std::enable_if<    Stuff::LA::is_matrix< MatrixType >::value
                           ...
                           , std::unique_ptr< WeightedL2MatrixOperator< WeightFunctionType, SpaceType, MatrixType > >
                           >::type
...
make_weighted_l2_matrix_operator(const WeightFunctionType& weight,
                                 ...
                                 const size_t over_integrate = 0)
{
  return DSC::make_unique< WeightedL2MatrixOperator
      < WeightFunctionType, RangeSpaceType, MatrixType, GridViewType, SourceSpaceType > >
...
public:
             ...
             DiscreteFunction< RangeSpaceType, VectorType >& range) const
  {
    typedef typename Stuff::LA::Container< typename VectorType::ScalarType, VectorType::sparse_matrix_type >::MatrixType
        MatrixType;
    auto op = make_weighted_l2_matrix_operator< MatrixType >(weight_,
                                                             source.space(),
                                                             range.space(),
                                                             grid_view_,
                                                             over_integrate_);
...
template< class GridViewType, class WeightFunctionType >
    typename std::enable_if<    Stuff::Grid::is_grid_layer< GridViewType >::value
                           ...
                           , std::unique_ptr< WeightedL2Operator< WeightFunctionType, GridViewType,
                                                                  typename WeightFunctionType::RangeFieldType > >
                           >::type
make_weighted_l2_operator(const WeightFunctionType& weight,
                          const GridViewType& grid_view,
                          const size_t over_integrate = 0)
{
  return DSC::make_unique
      < WeightedL2Operator< WeightFunctionType, GridViewType, typename WeightFunctionType::RangeFieldType > >
