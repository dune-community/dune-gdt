...
class DUNE_DEPRECATED_MSG(
    "Use DirichletProjectionLocalizableOperator in dune/gdt/operators/projections/dirichlet.hh instead (29.09.2015)!")
...
void DUNE_DEPRECATED_MSG("Use Dune::GDT::project() instead (08.02.2015)! (drop the Operators NS!)")
...
void DUNE_DEPRECATED_MSG("Use Dune::GDT::project_dirichlet() instead (08.02.2015)! (drop the Operators NS!)")
...
DirichletProjectionLocalizable<GV, S, R> make_localizable_dirichlet_projection(
    const GV& grid_view, const Stuff::Grid::BoundaryInfoInterface<typename GV::Intersection>& boundary_info,
    const S& source, R& range)
{
