...
public:
  ...
  void apply(const ConstDiscreteFunction< DiscontinuousLagrangeSpace::FemLocalfunctionsWrapper< SGP, 1, FieldType, 1, 1 >, SV >&
                source,
             DiscreteFunction< DiscontinuousLagrangeSpace::FemLocalfunctionsWrapper< RGP, 1, FieldType, 1, 1 >, RV >&
                range) const
  {
