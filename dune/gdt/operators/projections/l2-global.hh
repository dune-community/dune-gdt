...
private:
  ...
  typedef L2VolumeVectorFunctional< SourceType, typename RangeType::SpaceType, VectorType, GridViewType > RhsFunctionalType;
                                               ...
                                               const size_t over_integrate = 0)
{
  return DSC::make_unique<
      L2GlobalProjectionLocalizableOperator< GridViewType, SourceType,
                                             DiscreteFunction< SpaceType, VectorType >,
                                             VectorType::sparse_matrix_type > >(grid_view,
                                                                                source,
                                                                                range,
                                                                                over_integrate);
                                               ...
                                               const size_t over_integrate = 0)
{
  return DSC::make_unique<
      L2GlobalProjectionLocalizableOperator< typename SpaceType::GridViewType,
                                             SourceType,
                                             DiscreteFunction< SpaceType, VectorType >,
                                             VectorType::sparse_matrix_type > >(range.space().grid_view(),
                                                                                source,
                                                                                range,
                                                                                over_integrate);
} // ... make_global_l2_projection_localizable_operator(...)
