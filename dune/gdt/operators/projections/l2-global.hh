...
public:
  ...
  typedef typename Stuff::LA::Container
      < typename RangeType::RangeFieldType, VectorType::sparse_matrix_type >::MatrixType MatrixType;
private:
...
public:
  L2GlobalProjectionLocalizableOperator(GridViewType grd_vw,
...
template< class GridViewType, class SourceType, class SpaceType, class VectorType >
    typename std::enable_if<    Stuff::Grid::is_grid_layer< GridViewType >::value
                           ...
                           , std::unique_ptr<
                                  L2GlobalProjectionLocalizableOperator< GridViewType, SourceType,
                                               ...
                                               const size_t over_integrate = 0)
{
  return DSC::make_unique<
      L2GlobalProjectionLocalizableOperator< GridViewType, SourceType,
                                             DiscreteFunction< SpaceType, VectorType > > >(grid_view,
                                                                                           source,
                                                                                           range,
                                                                                           over_integrate);
...
template< class SourceType, class SpaceType, class VectorType >
    typename std::enable_if<    Stuff::is_localizable_function< SourceType >::value
                             ...
                             && Stuff::LA::is_vector< VectorType >::value
                           , std::unique_ptr<
                                  L2GlobalProjectionLocalizableOperator< typename SpaceType::GridViewType,
                                                                         SourceType,
                                                                         DiscreteFunction< SpaceType, VectorType > >
                                            > >::type
                                               ...
                                               const size_t over_integrate = 0)
{
  return DSC::make_unique<
      L2GlobalProjectionLocalizableOperator< typename SpaceType::GridViewType,
                                             SourceType,
                                             DiscreteFunction< SpaceType, VectorType > > >(range.space().grid_view(),
                                                                                           source,
                                                                                           range,
                                                                                           over_integrate);
} // ... make_global_l2_projection_localizable_operator(...)
...
public:
             ...
             DiscreteFunction< S, V >& range) const
  {
    ...
    L2GlobalProjectionLocalizableOperator< GridViewType, SourceType, DiscreteFunction< S, V > >
        op(grid_view_, source, range, over_integrate_);
    op.apply();
  }
...
template< class GridViewType >
    typename std::enable_if< Stuff::Grid::is_grid_layer< GridViewType >::value
                           , std::unique_ptr< L2GlobalProjectionOperator< GridViewType > >
                           >::type
