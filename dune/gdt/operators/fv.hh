...
public:
  ...
  typedef AdvectionLaxFriedrichs<AnalyticalFluxImp, BoundaryValueFunctionImp, LocalizableFunctionImp> derived_type;

}; // class AdvectionLaxFriedrichsLocalizableTraits

template <class AnalyticalFluxImp, class BoundaryValueFunctionImp, class FVSpaceImp>
class AdvectionGodunovTraits : AdvectionTraitsBase<AnalyticalFluxImp, BoundaryValueFunctionImp, FVSpaceImp>
{
public:
...
class AdvectionLaxWendroffTraits : public AdvectionLaxFriedrichsTraits<AnalyticalFluxImp, BoundaryValueFunctionImp,
                                                                       FVSpaceImp, LocalizableFunctionImp>
{
public:
  typedef AdvectionLaxWendroff<AnalyticalFluxImp, BoundaryValueFunctionImp, FVSpaceImp, LocalizableFunctionImp>
      derived_type;
...
{
public:
  typedef AdvectionGodunovWithReconstruction<AnalyticalFluxImp, LocalizableFunctionImp, BoundaryValueFunctionImp,
                                             FVSpaceImp, slopeLimiter> derived_type;
}; // class AdvectionGodunovWithReconstructionTraits
...
public:
    ...
    , range_(range)
  {
    ...
    this->add(
        local_boundary_operator_, source_, range_, new DSG::ApplyOn::NonPeriodicBoundaryIntersections<GridViewType>());
  }
...
class AdvectionLaxFriedrichs
    : public Dune::GDT::OperatorInterface<internal::AdvectionLaxFriedrichsTraits<AnalyticalFluxImp,
                                                                                 BoundaryValueFunctionImp, FVSpaceImp,
                                                                                 LocalizableFunctionImp>>
{
public:
  typedef internal::AdvectionLaxFriedrichsTraits<AnalyticalFluxImp, BoundaryValueFunctionImp, LocalizableFunctionImp>
      Traits;
  ...
  typedef
      typename Dune::GDT::LaxFriedrichsNumericalCouplingFlux<AnalyticalFluxType, dimDomain> NumericalCouplingFluxType;
  typedef typename Dune::GDT::LaxFriedrichsNumericalBoundaryFlux<AnalyticalFluxType, BoundaryValueFunctionType,
                                                                 dimDomain> NumericalBoundaryFluxType;

  AdvectionLaxFriedrichs(const AnalyticalFluxType& analytical_flux, const LocalizableFunctionType& dx, const double dt,
                         const BoundaryValueFunctionType& boundary_values, const FVSpaceType& fv_space,
...
class AdvectionGodunov
    : public Dune::GDT::OperatorInterface<internal::AdvectionGodunovTraits<AnalyticalFluxImp, BoundaryValueFunctionImp>>
{
public:
  typedef internal::AdvectionGodunovTraits<AnalyticalFluxImp, BoundaryValueFunctionImp> Traits;
  typedef typename Traits::GridViewType GridViewType;
  typedef typename Traits::AnalyticalFluxType AnalyticalFluxType;
  typedef typename Traits::BoundaryValueFunctionType BoundaryValueFunctionType;
  ...
  typedef typename Dune::GDT::GodunovNumericalBoundaryFlux<AnalyticalFluxType, BoundaryValueFunctionType, dimDomain>
      NumericalBoundaryFluxType;

  AdvectionGodunov(const AnalyticalFluxType& analytical_flux, const BoundaryValueFunctionType& boundary_values,
  ...
  {
    auto current_boundary_values = boundary_values_.evaluate_at_time(time);
    AdvectionLocalizableDefault<AnalyticalFluxType, NumericalCouplingFluxType, NumericalBoundaryFluxType, typename BoundaryValueFunctionType::ExpressionFunctionType, SourceType, RangeType, >
...
class AdvectionLaxWendroff
    : public Dune::GDT::OperatorInterface<internal::AdvectionLaxWendroffTraits<AnalyticalFluxImp,
                                                                               ...
                                                                               BoundaryValueFunctionImp, FVSpaceImp>>
{
  typedef Dune::GDT::OperatorInterface<internal::AdvectionLaxWendroffTraits<AnalyticalFluxImp, LocalizableFunctionImp,
                                                                            BoundaryValueFunctionImp, FVSpaceImp>>
      OperatorBaseType;

public:
  typedef internal::AdvectionLaxWendroffTraits<AnalyticalFluxImp, LocalizableFunctionImp, BoundaryValueFunctionImp,
                                               FVSpaceImp> Traits;
  typedef typename Traits::GridViewType GridViewType;
  typedef typename Traits::AnalyticalFluxType AnalyticalFluxType;
  typedef typename Traits::LocalizableFunctionType LocalizableFunctionType;
  ...
  AdvectionLaxWendroff(const AnalyticalFluxType& analytical_flux, const LocalizableFunctionType& dx, const double dt,
                       const BoundaryValueFunctionType& boundary_values, const FVSpaceType& fv_space,
                       const bool is_linear = false)
    : OperatorBaseType()
    , analytical_flux_(analytical_flux)
  ...
  template <class SourceType, class RangeType>
  void apply(const SourceType& source, RangeType& range, const double time = 0.0, const bool = false,
             const double = 0) const
  {
    ...
    AdvectionLaxWendroffLocalizable<AnalyticalFluxType,
                                    ...
                                    RangeType>
        localizable_operator(analytical_flux_, dx_, dt_, source, *current_boundary_values, range, is_linear_);
    localizable_operator.apply();
  }
...
template <class AnalyticalFluxImp, class LocalizableFunctionImp, class SourceImp, class BoundaryValueFunctionImp,
          class RangeImp, SlopeLimiters slopeLimiter>
class AdvectionGodunovWithReconstructionLocalizable
    : public Dune::GDT::
          LocalizableOperatorInterface<internal::
                                           AdvectionGodunovWithReconstructionLocalizableTraits<AnalyticalFluxImp,
                                                                                               LocalizableFunctionImp,
                                                                                               SourceImp,
                                                                                               BoundaryValueFunctionImp,
                                                                                               RangeImp, slopeLimiter>>,
      public SystemAssembler<typename RangeImp::SpaceType>
{
  ...
  typedef AdvectionGodunovWithReconstructionLocalizable<AnalyticalFluxImp, LocalizableFunctionImp, SourceImp,
                                                        BoundaryValueFunctionImp, RangeImp, slopeLimiter> ThisType;

public:
  typedef internal::AdvectionGodunovWithReconstructionLocalizableTraits<AnalyticalFluxImp, LocalizableFunctionImp,
                                                                        SourceImp, BoundaryValueFunctionImp, RangeImp,
                                                                        slopeLimiter> Traits;
  ...
  typedef typename Dune::GDT::LocalEvaluation::Godunov::Dirichlet<LocalizableFunctionImp, BoundaryValueFunctionType>
      NumericalBoundaryFluxType;
  ...
  typedef Spaces::DG::PdelabBasedProduct<GridViewType,
                                         1, // polOrder
                                         RangeFieldType, dimRange, dimRangeCols> DGSpaceType;
  ...
  AdvectionGodunovWithReconstructionLocalizable(const AnalyticalFluxType& analytical_flux,
                                                ...
                                                const BoundaryValueFunctionType boundary_values, RangeType& range,
                                                const bool is_linear, const bool save_partitioning)
    : OperatorBaseType()
    ...
    , save_partitioning_(save_partitioning)
  {
    ...
    const auto num_partitions =
        DSC_CONFIG_GET("threading.partition_factor", 1u) * DS::threadManager().current_threads();
...
//}
  ...
  void apply()
  {
    ...
    this->add(boundary_assembler_,
              *reconstruction_,
              range_,
              new DSG::ApplyOn::NonPeriodicBoundaryIntersections<GridViewType>());
...
// walk the grid to reconstruct
    ...
    for (const EntityType& entity : entity_range) {
      ...
      for (auto i_it = grid_view_.ibegin(entity); i_it != i_it_end; ++i_it) {
        ...
        if (intersection.neighbor()) {
          ...
          if (intersection.geometry().center()[0] < entity_center[0]) {
            ...
            left_boundary_value =
                boundary_values_.local_function(entity)->evaluate(intersection.geometryInInside().center());
          } else {
      ...
      const auto u_left = on_left_boundary
                              ? left_boundary_value
                              : source_.local_discrete_function(left_neighbor)
                                    ->evaluate(left_neighbor.geometry().local(left_neighbor.geometry().center()));
      const auto u_right = on_right_boundary
                               ? right_boundary_value
                               : source_.local_discrete_function(right_neighbor)
                                     ->evaluate(right_neighbor.geometry().local(right_neighbor.geometry().center()));
      ...
      if (!eigenvectors_calculated_) {
        ...
        ::Eigen::EigenSolver<typename EigenMatrixType::BackendType> eigen_solver(
            DSC::fromString<EigenMatrixType>(DSC::toString(analytical_flux_.jacobian(u_entity))).backend());
      ...
      const StuffFieldVectorType w_slope = internal::ChooseLimiter<slopeLimiter, StuffFieldVectorType>::limit(
...
template <class AnalyticalFluxImp, class LocalizableFunctionImp, class SourceImp, class BoundaryValueFunctionImp,
          class RangeImp, SlopeLimiters slopeLimiter>
std::unique_ptr<RangedPartitioning<
    typename AdvectionGodunovWithReconstructionLocalizable<AnalyticalFluxImp, LocalizableFunctionImp, SourceImp,
                                                           BoundaryValueFunctionImp, RangeImp,
                                                           slopeLimiter>::GridViewType,
    0>> AdvectionGodunovWithReconstructionLocalizable<AnalyticalFluxImp, LocalizableFunctionImp, SourceImp,
                                                      BoundaryValueFunctionImp, RangeImp, slopeLimiter>::partitioning_;
#else
}; // class AdvectionGodunovWithReconstructionLocalizable
#endif
...
template <class AnalyticalFluxImp, class LocalizableFunctionImp, class SourceImp, class BoundaryValueFunctionImp,
          class RangeImp, SlopeLimiters slopeLimiter>
bool AdvectionGodunovWithReconstructionLocalizable<AnalyticalFluxImp, LocalizableFunctionImp, SourceImp,
                                                   BoundaryValueFunctionImp, RangeImp, slopeLimiter>::first_run_(true);

template <class AnalyticalFluxImp, class LocalizableFunctionImp, class SourceImp, class BoundaryValueFunctionImp,
          class RangeImp, SlopeLimiters slopeLimiter>
std::unique_ptr<typename AdvectionGodunovWithReconstructionLocalizable<AnalyticalFluxImp, LocalizableFunctionImp,
                                                                       SourceImp, BoundaryValueFunctionImp, RangeImp,
                                                                       slopeLimiter>::DGSpaceType>
    AdvectionGodunovWithReconstructionLocalizable<AnalyticalFluxImp, LocalizableFunctionImp, SourceImp,
                                                  BoundaryValueFunctionImp, RangeImp, slopeLimiter>::dg_space_;

template <class AnalyticalFluxImp, class LocalizableFunctionImp, class SourceImp, class BoundaryValueFunctionImp,
          class RangeImp, SlopeLimiters slopeLimiter>
std::unique_ptr<typename AdvectionGodunovWithReconstructionLocalizable<AnalyticalFluxImp, LocalizableFunctionImp,
                                                                       SourceImp, BoundaryValueFunctionImp, RangeImp,
                                                                       slopeLimiter>::ReconstructedDiscreteFunctionType>
    AdvectionGodunovWithReconstructionLocalizable<AnalyticalFluxImp, LocalizableFunctionImp, SourceImp,
                                                  BoundaryValueFunctionImp, RangeImp, slopeLimiter>::reconstruction_;

template <class AnalyticalFluxImp, class LocalizableFunctionImp, class SourceImp, class BoundaryValueFunctionImp,
          class RangeImp, SlopeLimiters slopeLimiter>
typename AdvectionGodunovWithReconstructionLocalizable<AnalyticalFluxImp, LocalizableFunctionImp, SourceImp,
                                                       BoundaryValueFunctionImp, RangeImp,
                                                       slopeLimiter>::StuffFieldMatrixType
    AdvectionGodunovWithReconstructionLocalizable<AnalyticalFluxImp, LocalizableFunctionImp, SourceImp,
                                                  BoundaryValueFunctionImp, RangeImp, slopeLimiter>::eigenvectors_(0);
...
typename AdvectionGodunovWithReconstructionLocalizable<AnalyticalFluxImp, LocalizableFunctionImp, SourceImp,
    ...
    AdvectionGodunovWithReconstructionLocalizable<AnalyticalFluxImp, LocalizableFunctionImp, SourceImp,
                                                  BoundaryValueFunctionImp, RangeImp,
                                                  slopeLimiter>::eigenvectors_inverse_(0);

template <class AnalyticalFluxImp, class LocalizableFunctionImp, class SourceImp, class BoundaryValueFunctionImp,
          class RangeImp, SlopeLimiters slopeLimiter>
bool AdvectionGodunovWithReconstructionLocalizable<AnalyticalFluxImp, LocalizableFunctionImp, SourceImp,
                                                   BoundaryValueFunctionImp, RangeImp,
                                                   slopeLimiter>::eigenvectors_calculated_(false);
...
{
  typedef Dune::GDT::
      OperatorInterface<internal::AdvectionGodunovWithReconstructionTraits<AnalyticalFluxImp, LocalizableFunctionImp,
                                                                           BoundaryValueFunctionImp, FVSpaceImp,
                                                                           slopeLimiter>> OperatorBaseType;

public:
  typedef internal::AdvectionGodunovWithReconstructionTraits<AnalyticalFluxImp, LocalizableFunctionImp,
                                                             BoundaryValueFunctionImp, FVSpaceImp, slopeLimiter> Traits;
  typedef typename Traits::GridViewType GridViewType;
  typedef typename Traits::AnalyticalFluxType AnalyticalFluxType;
  typedef typename Traits::LocalizableFunctionType LocalizableFunctionType;
  typedef typename Traits::BoundaryValueFunctionType BoundaryValueFunctionType;
  ...
  AdvectionGodunovWithReconstruction(const AnalyticalFluxType& analytical_flux, const LocalizableFunctionType& dx,
                                     const double dt, const BoundaryValueFunctionType boundary_values,
                                     const FVSpaceType& fv_space, const bool is_linear = false,
  ...
  template <class SourceType, class RangeType>
  void apply(const SourceType& source, RangeType& range, const double time = 0.0, const bool visualize = false,
             const size_t save_counter = 0) const
  {
    ...
    AdvectionGodunovWithReconstructionLocalizable<AnalyticalFluxType,
                                                  ...
                                                  typename BoundaryValueFunctionType::ExpressionFunctionType,
                                                  RangeType,
                                                  slopeLimiter> localizable_operator(analytical_flux_,
                                                                                     dx_,
                                                                                     dt_,
                                                                                     source,
                                                                                     current_boundary_values_,
                                                                                     range,
                                                                                     is_linear_,
                                                                                     save_partitioning_);
...
class AdvectionSourceLocalizable
    : public Dune::GDT::LocalizableOperatorInterface<internal::AdvectionSourceLocalizableTraits<SourceFunctionImp,
                                                                                                SourceImp, RangeImp>>,
      public SystemAssembler<typename RangeImp::SpaceType>
{
  typedef Dune::GDT::LocalizableOperatorInterface<internal::AdvectionSourceLocalizableTraits<SourceFunctionImp,
                                                                                             SourceImp, RangeImp>>
      OperatorBaseType;
  typedef SystemAssembler<typename RangeImp::SpaceType> AssemblerBaseType;

public:
  typedef internal::AdvectionSourceLocalizableTraits<SourceFunctionImp, SourceImp, RangeImp> Traits;
  ...
  AdvectionSourceLocalizable(const SourceFunctionType& source_function, const SourceType& source, RangeType& range,
  ...
  void apply()
  {
    ...
    if (!partitioned_ && save_partitioning_) {
      const auto num_partitions =
          DSC_CONFIG_GET("threading.partition_factor", 1u) * DS::threadManager().current_threads();
      partitioning_ =
          DSC::make_unique<RangedPartitioning<GridViewType, 0>>(source_.space().grid_view(), num_partitions);
      partitioned_ = true;
    }
    if (save_partitioning_)
      this->assemble(*partitioning_);
...
template <class SourceFunctionImp, class SourceImp, class RangeImp>
bool AdvectionSourceLocalizable<SourceFunctionImp, SourceImp, RangeImp>::partitioned_(false);

template <class SourceFunctionImp, class SourceImp, class RangeImp>
std::unique_ptr<RangedPartitioning<
    typename AdvectionSourceLocalizable<SourceFunctionImp, SourceImp, RangeImp>::GridViewType, 0>>
...
template <class SourceFunctionImp, class FVSpaceImp>
class AdvectionSource
    : public Dune::GDT::OperatorInterface<internal::AdvectionSourceTraits<SourceFunctionImp, FVSpaceImp>>
{
  typedef Dune::GDT::OperatorInterface<internal::AdvectionSourceTraits<SourceFunctionImp, FVSpaceImp>> OperatorBaseType;

public:
  typedef internal::AdvectionSourceTraits<SourceFunctionImp, FVSpaceImp> Traits;
  typedef typename Traits::GridViewType GridViewType;
  typedef typename Traits::SourceFunctionType SourceFunctionType;
  typedef typename Traits::FVSpaceType FVSpaceType;

  AdvectionSource(const SourceFunctionType& source_function, const FVSpaceType& fv_space,
                  const bool save_partitioning = false)
    : OperatorBaseType()
  ...
  void apply(const SourceType& source, RangeType& range, const double /*time*/ = 0.0) const
  {
    AdvectionSourceLocalizable<SourceFunctionType, SourceType, RangeType> localizable_operator(
        source_function_, source, range, save_partitioning_);
    localizable_operator.apply();
  }
