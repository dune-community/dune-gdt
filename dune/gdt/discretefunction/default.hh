...
public:
  ...
  void visualize(const std::string filename_prefix,
                 ...
                 const VTK::OutputType vtk_output_type = VTK::appendedraw) const
  {
    redirect_visualize(space(), filename_prefix, filename_suffix, subsampling, vtk_output_type, internal::ChooseVisualize< is_product_space< SpaceType >::value >());
  }
...
protected:
  ...
  {
    internal::static_for_loop< 0, ProductSpaceInterface< S, d, r, rC >::num_factors >::visualize(filename_prefix, filename_suffix, subsampling, vtk_output_type, *this);
  } // ... redirect_visualize(...)
