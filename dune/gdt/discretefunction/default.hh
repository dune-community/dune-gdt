...
// discrete_exact_solution_ time for loop to visualize all factors of a product space, see http://stackoverflow.com/a/11081785
...
struct static_for_loop
{
  ...
  static void visualize(const std::string filename_prefix,
                        ...
                        const DiscreteFunctionType& discrete_function)
  {
    visualize_helper< current_factor_index, true >::visualize_factor(filename_prefix,
                                                                                filename_suffix,
                                                                                subsampling,
                                                                                vtk_output_type,
                                                                                discrete_function);
    static_for_loop<current_factor_index + 1, last_factor_index>::visualize(filename_prefix,
                                                                            filename_suffix,
                                                                            subsampling,
                                                                            vtk_output_type,
                                                                            discrete_function);
...
public:
  ...
  void visualize(const std::string filename_prefix,
                 ...
                 const VTK::OutputType vtk_output_type = VTK::appendedraw) const
  {
    redirect_visualize(filename_prefix, filename_suffix, subsampling, vtk_output_type, internal::ChooseVisualize< is_product_space< SpaceType >::value >());
  }
  ...
  void visualize_factor(const std::string filename_prefix,
                        ...
                        const VTK::OutputType vtk_output_type = VTK::appendedraw) const
  {
    internal::visualize_helper< ii, is_product_space<SpaceType>::value >::visualize_factor(filename_prefix,
                                                                                           filename_suffix,
                                                                                           subsampling,
                                                                                           vtk_output_type,
                                                                                           *this);
...
protected:
  ...
  {
    internal::static_for_loop< 0, ProductSpaceInterface< SpaceTraits, SpaceType::dimDomain, SpaceType::dimRange, SpaceType::dimRangeCols >::num_factors >::visualize(filename_prefix, filename_suffix, subsampling, vtk_output_type, *this);
  } // ... redirect_visualize(...)
