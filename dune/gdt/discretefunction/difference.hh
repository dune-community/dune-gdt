...
public:
  ...
  static_assert(std::is_base_of<Stuff::LocalFunctionInterface<typename LocalMinuendType::Traits, DomainFieldType,
                                                              dimDomain, RangeFieldType, dimRangeRows, dimRangeCols>,
                                LocalMinuendType>::value,
                "LocalMinuendType has to be derived from Stuff::LocalFunctionInterface!");
  static_assert(std::is_base_of<Stuff::LocalFunctionInterface<typename LocalSubtrahendType::Traits, DomainFieldType,
                                                              dimDomain, RangeFieldType, dimRangeRows, dimRangeCols>,
...
class Difference
    : public Stuff::
          LocalFunctionInterface<DifferenceTraits<EntityImp, MinuendType, SubtrahendType>,
