...
{
  static_assert(
      std::is_base_of<Stuff::LocalFunctionInterface<typename MinuendType::Traits, D, d, R, r, 1>, MinuendType>::value,
...
public:
  ...
  public:
    typedef GDT::LocalFunction::Difference<LocalMinuendType, LocalSubtrahendType, DomainFieldType, dimDomain,
  ...
  {
    return typename LocalFunction<EntityType>::Type(minuend_.localFunction(entity), subtrahend_.localFunction(entity));
  }
