...
public:
  ...
  void assembleLocal(const SpaceInterface<TE, TEd, TEr, TErC>& testSpaceEntity,
                     ...
                     const IntersectionType& intersection, Dune::Stuff::LA::MatrixInterface<MEE, R>& entityEntityMatrix,
...
class Codim1CouplingOperatorAccumulateFunctor : public Stuff::Grid::Functor::Codim1<GridViewImp>
{
...
public:
  ...
  Codim1CouplingOperatorAccumulateFunctor(const GridViewType& grd_vw, const LocalOperatorType& local_op,
    ...
    , finalized_(false)
  {
    ...
    tmp_storage_ = std::unique_ptr<TmpMatricesProviderType>(
        new TmpMatricesProviderType({4, local_operator_.numTmpObjectsRequired()}, 1, 1));
  }
