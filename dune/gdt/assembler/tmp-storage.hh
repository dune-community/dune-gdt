...
template <class T>
class DUNE_DEPRECATED_MSG("Use Dune::Stuff::Common::TmpMatricesStorage instead (04.02.2015)!") Matrices
...
template <class T>
class DUNE_DEPRECATED_MSG("Use Dune::Stuff::Common::TmpVectorsStorage instead (04.02.2015)!") Vectors
