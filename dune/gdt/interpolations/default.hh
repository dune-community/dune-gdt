...
std::enable_if_t<std::is_same<XT::Grid::extract_entity_t<GV>, typename IGVT::Grid::template Codim<0>::Entity>::value,
                 void>
default_interpolation(XT::Functions::GridFunction<XT::Grid::extract_entity_t<GV>, r, rC, R> source,
...
void default_interpolation(XT::Functions::GridFunction<XT::Grid::extract_entity_t<GV>, r, rC, R> source,
                           DiscreteFunction<V, GV, r, rC, R>& target)
{
