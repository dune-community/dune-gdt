...
class ContinuousPdelabWrapper
  : public DefaultProductMapperFromTuple< typename PdelabSpaceImp::Traits::GridViewType, typename DSC::make_identical_tuple< ContinuousPdelabWrapper< PdelabSpaceImp, 1 >, rangeDim >::type >::type
{
  typedef ContinuousPdelabWrapper< PdelabSpaceImp, 1 > ScalarValuedMapperType;
  typedef typename DefaultProductMapperFromTuple< typename PdelabSpaceImp::Traits::GridViewType, typename Dune::Stuff::Common::make_identical_tuple< ScalarValuedMapperType, rangeDim >::type >::type BaseType;
public:
  ...
  ContinuousPdelabWrapper(const BackendType& pdelab_space)
    : BaseType(pdelab_space.gridView(), DSC::make_identical_tuple< ScalarValuedMapperType, rangeDim >::create(pdelab_space))
  {}
}; // class ContinuousPdelabWrapper
