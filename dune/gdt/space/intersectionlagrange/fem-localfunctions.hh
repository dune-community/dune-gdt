...
private:
  typedef FemLocalFunctions::
      IntersectionLocalFiniteElement<LagrangeLocalFiniteElement<Dune::EquidistantPointSet, dimDomain, DomainFieldType,
                                                                RangeFieldType>> FiniteElementType;
  typedef FemLocalFunctions::IntersectionBaseFunctionSetMap<Codim0GridPartImp, FiniteElementType,
