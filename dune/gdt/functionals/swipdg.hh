...
template <class DiffusionType, class DirichletType, class VectorImp, class SpaceImp,
          class GridViewImp = typename SpaceImp::GridViewType>
...
class DirichletBoundarySWIPDGTraits
{
  ...
  static_assert(std::is_base_of<Stuff::LocalizableFunctionInterface<
                                    typename DirichletType::EntityType, typename DirichletType::DomainFieldType,
                                    DirichletType::dimDomain, typename DirichletType::RangeFieldType,
                                    DirichletType::dimRange, DirichletType::dimRangeCols>,
                                DirichletType>::value,
      ...
      public SystemAssembler<SpaceImp, GridViewImp, SpaceImp>
{
  typedef Functionals::VectorBased<internal::DirichletBoundarySWIPDGTraits<DiffusionType, DirichletType, VectorImp,
                                                                           SpaceImp, GridViewImp>> FunctionalBaseType;
...
public:
  ...
  DirichletBoundarySWIPDG(const DiffusionType& diffusion, const DirichletType& dirichlet,
                          const BoundaryInfoType& boundary_info, VectorType& vector, const SpaceType& space,
                          const GridViewType& grid_view, const ScalarType beta = 1.0)
