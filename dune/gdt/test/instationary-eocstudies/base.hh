                                         ...
                                         const double dt)
{
  ...
  while (time < T_end + dt) {
    ...
    residual_op.apply_inverse(zero,
                              u_n_plus_one,
                              DXTC_TEST_CONFIG_HAS_SUB("setup.solve_instationary_system_implicit_euler.apply_inverse")
                                  ? DXTC_TEST_CONFIG_SUB("setup.solve_instationary_system_implicit_euler.apply_inverse")
