  ...
  , public LocalizableProductBase< SpaceType >
{
  ...
  {
    auto product = make_elliptic_localizable_product(this->factor_, this->tensor_function_, this->space_.grid_view(),
                                                     function, function);
    const auto result = product->apply2();
    auto product_tbb = make_elliptic_localizable_product(this->factor_, this->tensor_function_, this->space_.grid_view(),
                                                         function, function);
  ...
  , public MatrixOperatorBase< SpaceType >
{
  ...
  void constructible_by_ctor()
  {
    ...
    EllipticMatrixOperator< ExpressionFunctionType, void, SpaceType >
        DUNE_UNUSED(factor_no_matrix_1)(diffusion_factor, space);
    EllipticMatrixOperator< ExpressionFunctionType, void, SpaceType >
        DUNE_UNUSED(factor_no_matrix_2)(diffusion_factor, space, grid_view);
    EllipticMatrixOperator< ExpressionFunctionType, void, SpaceType >
        DUNE_UNUSED(factor_no_matrix_3)(diffusion_factor, space, space, grid_view);
    //       full argument list
    ...
    //       simplified argument list
    EllipticMatrixOperator< ExpressionFunctionType, void, SpaceType >
        DUNE_UNUSED(factor_no_matrix_7)(1, diffusion_factor, space);
    EllipticMatrixOperator< ExpressionFunctionType, void, SpaceType >
        DUNE_UNUSED(factor_no_matrix_8)(1, diffusion_factor, space, grid_view);
    EllipticMatrixOperator< ExpressionFunctionType, void, SpaceType >
        DUNE_UNUSED(factor_no_matrix_9)(1, diffusion_factor, space, space, grid_view);
    //       full argument list
    EllipticMatrixOperator< ExpressionFunctionType, void, SpaceType, MatrixType, GridViewType, SpaceType, double >
    ...
    //       simplified argument list
    EllipticMatrixOperator< ExpressionFunctionType, void, SpaceType >
        DUNE_UNUSED(factor_matrix_1)(diffusion_factor, matrix, space);
    EllipticMatrixOperator< ExpressionFunctionType, void, SpaceType >
        DUNE_UNUSED(factor_matrix_2)(diffusion_factor, matrix, space, grid_view);
    EllipticMatrixOperator< ExpressionFunctionType, void, SpaceType >
        DUNE_UNUSED(factor_matrix_3)(diffusion_factor, matrix, space, space, grid_view);
    //       full argument list
    EllipticMatrixOperator< ExpressionFunctionType, void, SpaceType, MatrixType, GridViewType, SpaceType, double >
    ...
    //       simplified argument list
    EllipticMatrixOperator< ExpressionFunctionType, void, SpaceType >
        DUNE_UNUSED(factor_matrix_7)(1, diffusion_factor, matrix, space);
    EllipticMatrixOperator< ExpressionFunctionType, void, SpaceType >
        DUNE_UNUSED(factor_matrix_8)(1, diffusion_factor, matrix, space, grid_view);
    EllipticMatrixOperator< ExpressionFunctionType, void, SpaceType >
        DUNE_UNUSED(factor_matrix_9)(1, diffusion_factor, matrix, space, space, grid_view);
    //       full argument list
    EllipticMatrixOperator< ExpressionFunctionType, void, SpaceType, MatrixType, GridViewType, SpaceType, double >
    ...
    //     without over_integrate
    //       simplified argument list
    EllipticMatrixOperator< TensorFunctionType, void, SpaceType >
        DUNE_UNUSED(tensor_no_matrix_1)(diffusion_tensor, space);
    EllipticMatrixOperator< TensorFunctionType, void, SpaceType >
        DUNE_UNUSED(tensor_no_matrix_2)(diffusion_tensor, space, grid_view);
    EllipticMatrixOperator< TensorFunctionType, void, SpaceType >
        DUNE_UNUSED(tensor_no_matrix_3)(diffusion_tensor, space, space, grid_view);
    //       full argument list
    ...
    //       simplified argument list
    EllipticMatrixOperator< TensorFunctionType, void, SpaceType >
        DUNE_UNUSED(tensor_no_matrix_7)(1, diffusion_tensor, space);
    EllipticMatrixOperator< TensorFunctionType, void, SpaceType >
        DUNE_UNUSED(tensor_no_matrix_8)(1, diffusion_tensor, space, grid_view);
    EllipticMatrixOperator< TensorFunctionType, void, SpaceType >
        DUNE_UNUSED(tensor_no_matrix_9)(1, diffusion_tensor, space, space, grid_view);
    //       full argument list
    EllipticMatrixOperator< TensorFunctionType, void, SpaceType, MatrixType, GridViewType, SpaceType, double >
    ...
    //       simplified argument list
    EllipticMatrixOperator< TensorFunctionType, void, SpaceType >
        DUNE_UNUSED(tensor_matrix_1)(diffusion_tensor, matrix, space);
    EllipticMatrixOperator< TensorFunctionType, void, SpaceType >
        DUNE_UNUSED(tensor_matrix_2)(diffusion_tensor, matrix, space, grid_view);
    EllipticMatrixOperator< TensorFunctionType, void, SpaceType >
        DUNE_UNUSED(tensor_matrix_3)(diffusion_tensor, matrix, space, space, grid_view);
    //       full argument list
    EllipticMatrixOperator< TensorFunctionType, void, SpaceType, MatrixType, GridViewType, SpaceType, double >
    ...
    //       simplified argument list
    EllipticMatrixOperator< TensorFunctionType, void, SpaceType >
        DUNE_UNUSED(tensor_matrix_7)(1, diffusion_tensor, matrix, space);
    EllipticMatrixOperator< TensorFunctionType, void, SpaceType >
        DUNE_UNUSED(tensor_matrix_8)(1, diffusion_tensor, matrix, space, grid_view);
    EllipticMatrixOperator< TensorFunctionType, void, SpaceType >
        DUNE_UNUSED(tensor_matrix_9)(1, diffusion_tensor, matrix, space, space, grid_view);
    //       full argument list
    EllipticMatrixOperator< TensorFunctionType, void, SpaceType, MatrixType, GridViewType, SpaceType, double >
    ...
    //     without over_integrate
    //       simplified argument list
    EllipticMatrixOperator< ExpressionFunctionType, TensorFunctionType, SpaceType >
        DUNE_UNUSED(both_no_matrix_1)(diffusion_factor, diffusion_tensor, space);
    EllipticMatrixOperator< ExpressionFunctionType, TensorFunctionType, SpaceType >
        DUNE_UNUSED(both_no_matrix_2)(diffusion_factor, diffusion_tensor, space, grid_view);
    EllipticMatrixOperator< ExpressionFunctionType, TensorFunctionType, SpaceType >
        DUNE_UNUSED(both_no_matrix_3)(diffusion_factor, diffusion_tensor, space, space, grid_view);
    //       full argument list
    EllipticMatrixOperator< ExpressionFunctionType, TensorFunctionType, SpaceType, MatrixType, GridViewType, SpaceType, double >
    ...
    //       simplified argument list
    EllipticMatrixOperator< ExpressionFunctionType, TensorFunctionType, SpaceType >
        DUNE_UNUSED(both_no_matrix_7)(1, diffusion_factor, diffusion_tensor, space);
    EllipticMatrixOperator< ExpressionFunctionType, TensorFunctionType, SpaceType >
        DUNE_UNUSED(both_no_matrix_8)(1, diffusion_factor, diffusion_tensor, space, grid_view);
    EllipticMatrixOperator< ExpressionFunctionType, TensorFunctionType, SpaceType >
        DUNE_UNUSED(both_no_matrix_9)(1, diffusion_factor, diffusion_tensor, space, space, grid_view);
    //       full argument list
    EllipticMatrixOperator< ExpressionFunctionType, TensorFunctionType, SpaceType, MatrixType, GridViewType, SpaceType, double >
    ...
    //       simplified argument list
    EllipticMatrixOperator< ExpressionFunctionType, TensorFunctionType, SpaceType >
        DUNE_UNUSED(both_matrix_1)(diffusion_factor, diffusion_tensor, matrix, space);
    EllipticMatrixOperator< ExpressionFunctionType, TensorFunctionType, SpaceType >
        DUNE_UNUSED(both_matrix_2)(diffusion_factor, diffusion_tensor, matrix, space, grid_view);
    EllipticMatrixOperator< ExpressionFunctionType, TensorFunctionType, SpaceType >
        DUNE_UNUSED(both_matrix_3)(diffusion_factor, diffusion_tensor, matrix, space, space, grid_view);
    //       full argument list
    EllipticMatrixOperator< ExpressionFunctionType, TensorFunctionType, SpaceType, MatrixType, GridViewType, SpaceType, double >
    ...
    //       simplified argument list
    EllipticMatrixOperator< ExpressionFunctionType, TensorFunctionType, SpaceType >
        DUNE_UNUSED(both_matrix_7)(1, diffusion_factor, diffusion_tensor, matrix, space);
    EllipticMatrixOperator< ExpressionFunctionType, TensorFunctionType, SpaceType >
        DUNE_UNUSED(both_matrix_8)(1, diffusion_factor, diffusion_tensor, matrix, space, grid_view);
    EllipticMatrixOperator< ExpressionFunctionType, TensorFunctionType, SpaceType >
        DUNE_UNUSED(both_matrix_9)(1, diffusion_factor, diffusion_tensor, matrix, space, space, grid_view);
    //       full argument list
    EllipticMatrixOperator< ExpressionFunctionType, TensorFunctionType, SpaceType, MatrixType, GridViewType, SpaceType, double >
  ...
  void constructible_by_factory()
  {
    ...
    auto DUNE_UNUSED(op_03) = make_elliptic_matrix_operator< MatrixType >(diffusion_factor, diffusion_tensor, space, grid_view);
    auto DUNE_UNUSED(op_04) = make_elliptic_matrix_operator< MatrixType >(diffusion_factor, diffusion_tensor, space, grid_view, 1);
    auto DUNE_UNUSED(op_05) = make_elliptic_matrix_operator< MatrixType >(diffusion_factor, diffusion_tensor, space, space, grid_view);
    auto DUNE_UNUSED(op_06) = make_elliptic_matrix_operator< MatrixType >(diffusion_factor, diffusion_tensor, space, space, grid_view, 1);
    //   with matrix
    ...
    auto DUNE_UNUSED(op_09) = make_elliptic_matrix_operator(diffusion_factor, diffusion_tensor, matrix, space, grid_view);
    auto DUNE_UNUSED(op_10) = make_elliptic_matrix_operator(diffusion_factor, diffusion_tensor, matrix, space, grid_view, 1);
    auto DUNE_UNUSED(op_11) = make_elliptic_matrix_operator(diffusion_factor, diffusion_tensor, matrix, space, space, grid_view);
    auto DUNE_UNUSED(op_12) = make_elliptic_matrix_operator(diffusion_factor, diffusion_tensor, matrix, space, space, grid_view, 1);
  ...
  , public OperatorBase< SpaceType >
{
  ...
  void constructible_by_ctor()
  {
    ...
    EllipticOperator< ExpressionFunctionType, void, GridViewType >
        DUNE_UNUSED(only_factor)(          grid_view, diffusion_factor);
    EllipticOperator< ExpressionFunctionType, void, GridViewType >
        DUNE_UNUSED(only_factor_w_over)(1, grid_view, diffusion_factor);

    EllipticOperator< TensorFunctionType, void, GridViewType >
        DUNE_UNUSED(only_tensor)(          grid_view, diffusion_tensor);
    EllipticOperator< TensorFunctionType, void, GridViewType >
        DUNE_UNUSED(only_tensor_w_over)(1, grid_view, diffusion_tensor);

    EllipticOperator< ExpressionFunctionType, TensorFunctionType, GridViewType >
        DUNE_UNUSED(both)(          grid_view, diffusion_factor, diffusion_tensor);
    EllipticOperator< ExpressionFunctionType, TensorFunctionType, GridViewType >
        DUNE_UNUSED(both_w_over)(1, grid_view, diffusion_factor, diffusion_tensor);
  } // ... constructible_by_ctor(...)
