...
#include <dune/gdt/test/hyperbolic/pn-discretization.hh>
...
int main(int argc, char** argv)
{
  ...
  static constexpr size_t momentOrder = 3; // replacethisline
  ...
  using TestCaseType =
      //    Hyperbolic::Problems::KineticTransport::PlaneSourcePnTestCase<Yasp1Grid, BasisfunctionType, reconstruct>;
      //    Hyperbolic::Problems::KineticTransport::SourceBeamPnTestCase<Yasp1Grid, BasisfunctionType, reconstruct>;
      //      Hyperbolic::Problems::KineticTransport::PointSourcePnTestCase<Yasp3Grid, BasisfunctionType, reconstruct>;
      //      Hyperbolic::Problems::KineticTransport::CheckerboardPnTestCase<Yasp3Grid, BasisfunctionType, reconstruct>;
      Hyperbolic::Problems::KineticTransport::ShadowPnTestCase<Yasp3Grid, BasisfunctionType, reconstruct>;
