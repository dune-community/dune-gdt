...
TYPED_TEST(linearelliptic_SWIPDG_discretization, eoc_study_using_pdelab_and_eigen_and_sgrid) {
  this->template eoc_study< ChooseSpaceBackend::pdelab, Stuff::LA::ChooseBackend::eigen_sparse >();
}

#else

TEST(DISABLED_linearelliptic_SWIPDG_discretization, eoc_study_using_pdelab_and_eigen_and_sgrid) {}
