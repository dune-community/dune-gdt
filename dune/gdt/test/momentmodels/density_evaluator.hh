...
public:
  ...
  /** \short Computes and stores exp(alpha^T b) for all quadrature points on this entity
   *
   * These values are needed in several places (to compute u, H, kinetic fluxes, ...) and are quite expensive to
   * compute, so we do not want to compute this again and again.
   */
