...
using Burgers1dExplicitDgP1Test = BurgersExplicitTest<YASP_1D_EQUIDISTANT_OFFSET>;
TEST_F(Burgers1dExplicitDgP1Test, periodic_boundaries__numerical_upwind_flux)
{
...
TEST_F(Burgers1dExplicitDgP1Test, periodic_boundaries__numerical_lax_riedrichs_flux)
{
