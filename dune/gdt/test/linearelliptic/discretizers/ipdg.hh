...
public:
                                       ...
                                       const ProblemType& problem, const int level = 0)
  {
    ...
    // inner face terms
    typedef LocalCouplingIntegralOperator<LocalEvaluation::EllipticIpdg::Inner<DiffusionFactorType,
                                                                               DiffusionTensorType,
                                                                               method>> CouplingOperatorType;
    ...
    // * rhs
    typedef LocalFaceIntegralFunctional<LocalEvaluation::EllipticIpdg::
                                            BoundaryRHS<FunctionType, DiffusionFactorType, DiffusionTensorType, method>>
