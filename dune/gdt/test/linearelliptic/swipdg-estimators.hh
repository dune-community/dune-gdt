...
class LinearEllipticSwipdgEstimatorStudy
  : public LinearEllipticEocStudy< TestCaseImp, DiscretizerImp >
{
...
private:
  ...
  typedef LinearElliptic::SwipdgFluxreconstrutionEstimators::LocalNonconformityESV2007
      < SpaceType, VectorType, DiffusionFactorType, DiffusionTensorType > LocalNonconformityESV2007Estimator;
  typedef LinearElliptic::SwipdgFluxreconstrutionEstimators::LocalResidualESV2007
      < SpaceType, VectorType, FunctionType, DiffusionFactorType, DiffusionTensorType > LocalResidualESV2007Estimator;
  typedef LinearElliptic::SwipdgFluxreconstrutionEstimators::LocalDiffusiveFluxESV2007
      < SpaceType, VectorType, DiffusionFactorType, DiffusionTensorType > LocalDiffusiveFluxESV2007Estimator;
  typedef LinearElliptic::SwipdgFluxreconstrutionEstimators::ESV2007
      < SpaceType, VectorType, FunctionType, DiffusionFactorType, DiffusionTensorType > ESV2007Estimator;
  typedef LinearElliptic::SwipdgFluxreconstrutionEstimators::ESV2007AlternativeSummation
      < SpaceType, VectorType, FunctionType, DiffusionFactorType, DiffusionTensorType > ESV2007AlternativeSummationEstimator;
...
public:
  ...
  virtual std::vector< double > expected_results(const std::string type) const override final
  {
    ...
    return LinearEllipticSwipdgEstimatorExpectations< TestCaseType, Discretizer::type, polOrder >::results(this->test_case_, type);
  }
...
struct linearelliptic_SWIPDG_estimators
  : public ::testing::Test
{
