                ...
                const std::string type)
{
  if (type == "L2") {
    ...
    return {1.74e+00, 7.33e-01};
#else
    return {7.33e-01, 1.48e-01, 3.82e-02};
#endif
  } else if (type == "H1_semi" || type == "energy") {
#if DXT_DISABLE_LARGE_TESTS
    return {1.01e+00, 7.20e-01};
#else
    return {7.20e-01, 3.59e-01, 1.84e-01};
#endif
  } else
...
std::vector<double> LinearEllipticEocExpectations<
    LinearElliptic::ER2007TestCase<AluCube2dGridType, double, 1>,
    LinearElliptic::ChooseDiscretizer::cg,
    1>::results(const LinearEllipticEocExpectations<LinearElliptic::ER2007TestCase<AluCube2dGridType, double, 1>,
                                                    LinearElliptic::ChooseDiscretizer::cg,
                                                    1>::TestCaseType&,
                const std::string type)
{
