...
std::vector<double>
LinearEllipticEocExpectations<LinearElliptic::ESV2007DdSubdomainsTestCase<AluConform2dGridType, double, 1>,
                              LinearElliptic::ChooseDiscretizer::block_ipdg,
                              1>::
    results(const LinearEllipticEocExpectations<LinearElliptic::
                                                    ESV2007DdSubdomainsTestCase<AluConform2dGridType, double, 1>,
                                                LinearElliptic::ChooseDiscretizer::block_ipdg,
                                                1>::TestCaseType&,
...
std::vector<double>
LinearEllipticEocExpectations<LinearElliptic::ESV2007DdSubdomainsTestCase<AluSimplex2dGridType, double, 1>,
                              LinearElliptic::ChooseDiscretizer::block_ipdg,
                              1>::
    results(const LinearEllipticEocExpectations<LinearElliptic::
                                                    ESV2007DdSubdomainsTestCase<AluSimplex2dGridType, double, 1>,
                                                LinearElliptic::ChooseDiscretizer::block_ipdg,
                                                1>::TestCaseType&,
            const std::string type)
