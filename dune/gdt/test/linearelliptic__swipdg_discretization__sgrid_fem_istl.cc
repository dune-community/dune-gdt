...
TYPED_TEST(linearelliptic_SWIPDG_discretization, eoc_study_using_fem_and_istl_and_sgrid) {
  this->template eoc_study< ChooseSpaceBackend::fem, Stuff::LA::ChooseBackend::istl_sparse >();
}

#else

TEST(DISABLED_linearelliptic_SWIPDG_discretization, eoc_study_using_fem_and_istl_and_sgrid) {}
