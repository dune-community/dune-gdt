...
TYPED_TEST(linearelliptic_SWIPDG_discretization, eoc_study_using_fem_and_istl_and_alugrid)
{
...
TEST(DISABLED_linearelliptic_SWIPDG_discretization, eoc_study_using_fem_and_istl_and_alugrid)
{
}
