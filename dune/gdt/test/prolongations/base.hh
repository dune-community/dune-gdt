 ...
 */
template <class CoarseSpaceType, class FineSpaceType, template <class, class, class> class ProlongationOperatorType>
struct LocalizableProlongationOperatorBase : public ::testing::Test
{
  ...
  void produces_correct_results(const RangeFieldType& tolerance = 1e-15) const
  {
    ...
    ProlongationOperatorType<GridViewType, CoarseDiscreteFunctionType, FineDiscreteFunctionType> prolongation_operator(
        fine_space.grid_view(), coarse_discrete_function, fine_discrete_function);
