...
template< class CoarseSpaceType,
          class FineSpaceType,
          template< class, class, class > class ProlongationOperatorImp >
struct LocalizableProlongationOperatorBase
  : public internal::ProlongationOperatorsBase< CoarseSpaceType, FineSpaceType >
{
...
template< class CoarseSpaceType,
          class FineSpaceType,
          template< class, class > class ProlongationOperatorImp >
