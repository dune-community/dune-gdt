    ...
    : public ProlongationOperatorBase<SpaceType, SpaceType, L2GlobalProlongationOperator>
{
  ...
  void constructible_by_factory(const double tolerance = 1e-15)
  {
    ...
    auto w_over_integrate DUNE_UNUSED = make_global_l2_prolongation_operator(grid_layer, 1);
    auto wo_over_integrate DUNE_UNUSED = make_global_l2_prolongation_operator(grid_layer);
  } // ... constructible_by_factory(...)
};
