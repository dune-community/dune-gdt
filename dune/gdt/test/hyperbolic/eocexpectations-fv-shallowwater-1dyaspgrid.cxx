...
class HyperbolicEocExpectations< Hyperbolic::ShallowWaterTestCase< Dune::YaspGrid< 1, Dune::EquidistantOffsetCoordinates< double, 1 > >, double >,
                                 Hyperbolic::ChooseDiscretizer::fv,
                                 1,
                                 anything >
  : public internal::HyperbolicEocExpectationsBase< 1 >
{
  typedef Hyperbolic::ShallowWaterTestCase< Dune::YaspGrid< 1, Dune::EquidistantOffsetCoordinates< double, 1 > >, double > TestCaseType;
public:
