...
template <>
class HyperbolicEocExpectations<Hyperbolic::PointSourceTestCase<Yasp3, double>,
    ...
    : public internal::HyperbolicEocExpectationsBase<3>
{
  typedef Hyperbolic::PointSourceTestCase<Yasp3, double> TestCaseType;
