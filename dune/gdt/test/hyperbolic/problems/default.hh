...
class Default
  : public ProblemInterface< E, D, d, R, r, rC >
{
...
public:
  ...
  // we need an EntityType for the Expression functions that model q(u,x) and f(u). As we do not have a grid for the u-variable,
  ...
  typedef typename Dune::GDT::GlobalFunctionBasedAnalyticalFlux< FluxExpressionFunctionType, E, D, d, R, r, rC > DefaultFluxType;
  typedef typename DS::Functions::Expression< E, D, d, R, r, rC > InitialValueExpressionFunctionType;
  typedef typename Dune::Stuff::Functions::FunctionCheckerboard< InitialValueExpressionFunctionType, E, D, d, R, r, rC > DefaultInitialValueType;
  ...
  typedef typename DS::Functions::FunctionCheckerboard< RHSExpressionFunctionType, E, D, d, R, r, rC > RHSCheckerboardFunctionType;
...
public:
  ...
  Default(const std::shared_ptr< const FluxType > flux_ptr,
          ...
          const std::shared_ptr< const InitialValueType > initial_values_ptr = std::make_shared< DefaultInitialValueType >("x", "[0 0 0]", 0),
