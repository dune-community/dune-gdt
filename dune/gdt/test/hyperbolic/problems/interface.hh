...
public:
  ...
  typedef Dune::GDT::AutonomousAnalyticalFluxInterface< EntityType, DomainFieldType, dimDomain, RangeFieldType, dimRange, dimRangeCols > FluxType;
  typedef Dune::GDT::RHSEvaluationInterface< EntityType, DomainFieldType, dimDomain, RangeFieldType, dimRange, dimRangeCols >  RHSType;
  typedef Dune::Stuff::LocalizableFunctionInterface< EntityType, DomainFieldType, dimDomain, RangeFieldType, dimRange, dimRangeCols >  InitialValueType;
  typedef typename Dune::Stuff::Functions::TimeDependentExpression< EntityType, DomainFieldType, dimDomain, RangeFieldType, dimRange, dimRangeCols, double > BoundaryValueType;
