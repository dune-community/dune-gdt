...
class Burgers : public Default<EntityImp, DomainFieldImp, domainDim, RangeFieldImp, rangeDim>
{
...
public:
  ...
  Burgers(const std::shared_ptr<const FluxType> flux =
          ...
          const std::shared_ptr<const RHSType> rhs =
              std::make_shared<DefaultRHSType>(*DefaultRHSType::create(default_config().sub("rhs"))),
