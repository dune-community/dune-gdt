...
template <class GridViewType,
          ...
          size_t dimRange>
class SourceBeamMn
    : public SourceBeamPn<BasisfunctionType, EntityType, DomainFieldType, dimDomain, U_, RangeFieldType, dimRange>
{
  typedef SourceBeamPn<BasisfunctionType, EntityType, DomainFieldType, dimDomain, U_, RangeFieldType, dimRange>
      BaseType;
...
template <class BasisfunctionImp,
          ...
          class RangeFieldImp,
          size_t dimRange>
class SourceBeamFokkerPlanckPn : public KineticFokkerPlanckEquation<BasisfunctionImp,
                                                                    EntityImp,
                                                                    DomainFieldImp,
                                                                    dimDomain,
                                                                    U_,
...
public:
  ...
  SourceBeamFokkerPlanckPn(const BasisfunctionType& basis_functions,
                           const XT::Common::Configuration& grid_cfg = default_grid_cfg(),
                           const XT::Common::Configuration& boundary_cfg = default_boundary_cfg())
    : BaseType(basis_functions, grid_cfg, boundary_cfg)
  {
...
protected:
  ...
  using BaseType::quadrature_;
  using BaseType::psi_vac_;
}; // class SourceBeamFokkerPlanckPn<...>
...
class SourceBeamTestCase
    : public Dune::GDT::Test::
          NonStationaryTestCase<G,
                                Problems::SourceBeamFokkerPlanckPn<B,
...
public:
  ...
  typedef typename Problems::SourceBeamFokkerPlanckPn<B, E, D, d, U, R, momentOrder + 1> ProblemType;
