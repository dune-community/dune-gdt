...
typename TwoBeams< E, D, d, R, rangeDim >::MatrixType
TwoBeams< E, D, d, R, rangeDim >::GetData::M_;

template< class E, class D, size_t d, class R, size_t rangeDim >
typename TwoBeams< E, D, d, R, rangeDim >::MatrixType
TwoBeams< E, D, d, R, rangeDim >::GetData::D_;

template< class E, class D, size_t d, class R, size_t rangeDim >
typename TwoBeams< E, D, d, R, rangeDim >::MatrixType
TwoBeams< E, D, d, R, rangeDim >::GetData::S_;

template< class E, class D, size_t d, class R, size_t rangeDim >
typename TwoBeams< E, D, d, R, rangeDim >::MatrixType
TwoBeams< E, D, d, R, rangeDim >::GetData::M_inverse_;

template< class E, class D, size_t d, class R, size_t rangeDim >
typename TwoBeams< E, D, d, R, rangeDim >::RangeType
TwoBeams< E, D, d, R, rangeDim >::GetData::base_integrated_(rangeDim);
...
template< class E, class D, size_t d, class R, size_t rangeDim >
bool
TwoBeams< E, D, d, R, rangeDim >::GetData::is_calculated_(false);

template< class E, class D, size_t d, class R, size_t rangeDim >
std::string
TwoBeams< E, D, d, R, rangeDim >::GetData::filename_("");

template< class E, class D, size_t d, class R, size_t rangeDim >
bool
TwoBeams< E, D, d, R, rangeDim >::GetData::exact_legendre_(true);
