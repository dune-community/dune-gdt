...
#ifndef DUNE_GDT_HYPERBOLIC_PROBLEMS_FLASH_HH
#define DUNE_GDT_HYPERBOLIC_PROBLEMS_FLASH_HH
...
class FlashBase : public PointSourceBase<FlashImp, E, D, d, R, r, rC, PointsVectorType>
{
  typedef FlashBase<FlashImp, E, D, d, R, r, rC, PointsVectorType> ThisType;
  typedef PointSourceBase<FlashImp, E, D, d, R, r, rC, PointsVectorType> BaseType;
...
public:
  ...
  static ConfigType default_grid_config()
  {
    ...
    grid_config["lower_left"] = "[-10 -10 -10]";
    grid_config["upper_right"] = "[10 10 10]";
                                      ...
                                      const PointsVectorType& v_points = create_equidistant_points())
  {
    ...
    rhs_config["name"] = FlashImp::DefaultRHSType::static_id();
    rhs_config["value"] = XT::Common::to_string(RangeType(0));
    return rhs_config;
  } // ... create_rhs_config()
...
#endif // DUNE_GDT_HYPERBOLIC_PROBLEMS_FLASH_HH
