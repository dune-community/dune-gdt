...
class Checkerboard : public KineticTransportEquation<BasisfunctionImp, GridLayerImp, U_>
{
...
public:
  ...
  Checkerboard(const BasisfunctionType& basis_functions,
  ...
  static std::string static_id()
  {
    ...
    return "checkerboard" + XT::Common::to_string(domainDim) + "d";
  }
          ...
          InstationaryTestCase<G,
                               Problems::
                                   KineticEquation<Problems::KineticTransport::
                                                       Checkerboard<Hyperbolic::Problems::
