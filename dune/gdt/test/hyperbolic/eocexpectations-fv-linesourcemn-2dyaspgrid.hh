...
#include "problems/momentmodels/kinetictransport/linesource.hh"
...
template <>
class HyperbolicEocExpectations<Hyperbolic::LineSourceMnTestCase<Yasp2, double>,
...
{
  typedef Hyperbolic::LineSourceMnTestCase<Yasp2, double> TestCaseType;
