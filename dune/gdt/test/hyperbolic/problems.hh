...
typedef testing::Types<  Dune::GDT::Hyperbolic::SourceBeamTestCase
                                                < Dune::YaspGrid< 1 >, double, 5 >
                         , Dune::GDT::Hyperbolic::Boltzmann2DCheckerboardTestCase
                                                < Dune::YaspGrid< 2 >, double, 1 >
