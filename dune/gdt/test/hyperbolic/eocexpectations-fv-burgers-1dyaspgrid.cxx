...
class HyperbolicEocExpectations< Hyperbolic::BurgersTestCase< Dune::YaspGrid< 1, Dune::EquidistantOffsetCoordinates< double, 1 > >, double, 1 >,
                                 Hyperbolic::ChooseDiscretizer::fv,
                                 1,
                                 anything >
  : public internal::HyperbolicEocExpectationsBase< 1 >
{
  typedef Hyperbolic::BurgersTestCase< Dune::YaspGrid< 1, Dune::EquidistantOffsetCoordinates< double, 1 > >, double, 1 > TestCaseType;
public:
