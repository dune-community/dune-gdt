                                                       ...
                                                       DiscreteFunctionType>>
{
  void constructible_by_factory()
  {
    ...
    auto w_grid_layer_w_over_integrate DUNE_UNUSED =
        make_local_l2_projection_localizable_operator(grid_layer, source, range, 1);
    auto w_grid_layer_wo_over_integrate DUNE_UNUSED =
        make_local_l2_projection_localizable_operator(grid_layer, source, range);
    auto wo_grid_layer_w_over_integrate DUNE_UNUSED = make_local_l2_projection_localizable_operator(source, range, 1);
    auto wo_grid_layer_wo_over_integrate DUNE_UNUSED = make_local_l2_projection_localizable_operator(source, range);
    ...
    : public ProjectionOperatorBase<SpaceType, L2LocalProjectionOperator<typename SpaceType::GridLayerType, double>>
{
  void constructible_by_factory()
  {
    ...
    auto w_over_integrate DUNE_UNUSED = make_local_l2_projection_operator(grid_layer, 1);
    auto wo_over_integrate DUNE_UNUSED = make_local_l2_projection_operator(grid_layer);
  } // ... constructible_by_factory(...)
};
