...
TYPED_TEST(linearelliptic_SWIPDG_discretization, eoc_study_using_pdelab_and_eigen_and_alugrid_order_1) {
  this->template eoc_study< ChooseSpaceBackend::pdelab, Stuff::LA::ChooseBackend::eigen_sparse, 1 >();
}
TYPED_TEST(linearelliptic_SWIPDG_discretization, eoc_study_using_pdelab_and_eigen_and_alugrid_order_2) {
  this->template eoc_study< ChooseSpaceBackend::pdelab, Stuff::LA::ChooseBackend::eigen_sparse, 2 >();
}

#else

TEST(DISABLED_linearelliptic_SWIPDG_discretization, eoc_study_using_pdelab_and_eigen_and_alugrid_order_1) {}
TEST(DISABLED_linearelliptic_SWIPDG_discretization, eoc_study_using_pdelab_and_eigen_and_alugrid_order_2) {}
