...
TYPED_TEST(linearelliptic_SWIPDG_discretization, eoc_study_using_pdelab_and_eigen_and_alugrid)
{
...
TEST(DISABLED_linearelliptic_SWIPDG_discretization, eoc_study_using_pdelab_and_eigen_and_alugrid)
{
}
