...
#define SPACE_DG_FEM_SGRID(dd, rr, pp) Dune::GDT::Spaces::DG::FemBased<S##dd##dLeafGridPartType, pp, double, rr>

#define SPACE_DG_FEM_YASPGRID(dd, rr, pp) Dune::GDT::Spaces::DG::FemBased<Yasp##dd##dLeafGridPartType, pp, double, rr>
...
#define SPACE_DG_FEM_SGRID_LEVEL(dd, rr, pp) Dune::GDT::Spaces::DG::FemBased<S##dd##dLevelGridPartType, pp, double, rr>
