...
public:
  ...
  //  void apply(const DiscreteFunctionDefaultConst< DiscontinuousLagrangeSpace::FemLocalfunctionsWrapper< SGP, sp, R,
  //  dimRange >, SV >& source,
  //                    DiscreteFunctionDefault< DiscontinuousLagrangeSpace::FemLocalfunctionsWrapper< RGP, rp, R,
  //                    dimRange >, RV >& range) const
  //  {
  //    //checks
  ...
  //    // create search in the source grid part
  //    typedef DiscreteFunctionDefaultConst< DiscontinuousLagrangeSpace::FemLocalfunctionsWrapper< SGP, sp, R, dimRange
  //    >, SV > SourceType;
  //    typedef DiscreteFunctionDefault< DiscontinuousLagrangeSpace::FemLocalfunctionsWrapper< RGP, rp, R, dimRange >,
  //    RV >      RangeType;
