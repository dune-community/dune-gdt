...
private:
  ...
  typedef typename DSC::StorageProvider< std::map< TimeFieldImp, DiscreteFunctionImp, typename internal::FloatCmpLt > > SolutionStorageProviderType;
...
public:
  ...
  {
    return solve(t_end, initial_dt, num_save_steps, save_solution, output_progress, visualize, filename_prefix, *solution_);
  }
