...
public:
   ...
   */
  virtual void solve(const TimeFieldType t_end, const TimeFieldType initial_dt, const size_t num_save_steps,
                     const bool save_solution, const bool output_progress, const bool visualize_solution,
                     const std::string filename_prefix, SolutionType& solution)
  {
  ...
  virtual void solve(const TimeFieldType t_end, const TimeFieldType initial_dt = 1e-4, const size_t num_save_steps = -1,
                     const bool save_solution = true, const bool output_progress = false,
                     const bool visualize_solution = false, const std::string filename_prefix = "solution")
  {
    solve(t_end,
          initial_dt,
          num_save_steps,
