...
public:
  ...
  {
  public:
    typedef Dune::DetailedDiscretizations::DiscreteFunctional::Local::Codim0::
        IntegralInduced<ThisType, InducingDiscreteFunctionType> Type;
  };
  ...
  {
    typedef Dune::DetailedDiscretizations::DiscreteFunctional::Local::Codim0::
        IntegralInduced<ThisType, InducingDiscreteFunctionType> LocalFunctionalType;
