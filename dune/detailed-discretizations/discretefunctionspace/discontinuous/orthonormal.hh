...
public:
  ...
  typedef Dune::DetailedDiscretizations::Mapper::Discontinuous<ThisType> MapperType;

  typedef Dune::DetailedDiscretizations::BaseFunctionSet::Orthonormal<ThisType> BaseFunctionSetType;
