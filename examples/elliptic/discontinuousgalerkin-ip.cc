...
#include <dune/gdt/localevaluation/ipdg-fluxes.hh>
...
int main(int argc, char** argv)
{
  try {
    ...
    typedef LocalOperator::
        Codim1BoundaryIntegral<LocalEvaluation::IPDGFluxes::BoundaryDirichletLHS<ExpressionFunctionType>>
    ...
    typedef LocalFunctional::Codim1Integral<LocalEvaluation::IPDGFluxes::BoundaryDirichletRHS<ExpressionFunctionType,
                                                                                              ExpressionFunctionType>>
