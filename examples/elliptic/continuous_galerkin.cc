...
int main(int argc, char** argv)
{
  try {
    ...
    //    GridPartType, polOrder > DiscreteH1Type;
    //    const DiscreteH1Type discreteH1(gridPart);
    //    typedef Dune::Detailed::Discretizations::DiscreteFunctionSpace::Sub::Linear::Dirichlet< DiscreteH1Type >
    //    AnsatzSpaceType;
    ...
    //    MatrixType systemMatrix = ContainerFactory::createSparseMatrix(ansatzSpace.map().size(),
    //    testSpace.map().size(), sparsityPattern);
