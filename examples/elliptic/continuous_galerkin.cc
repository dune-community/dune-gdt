...
int main(int argc, char** argv)
{
  try {
    ...
    typedef Dune::DetailedDiscretizations::DiscreteFunctional::Local::Codim0::Integral<ProductEvaluationType>
        L2FunctionalType;
    ...
    timer.reset();
    typedef Dune::DetailedDiscretizations::Assembler::Local::Codim0::Matrix<EllipticOperatorType>
    ...
    typedef Dune::DetailedDiscretizations::Assembler::System::Constrained<AnsatzSpaceType, TestSpaceType>
        SystemAssemblerType;
