...
class CGDiscretization : public DiscretizationBase<GridPartType>
{
...
template <class GridPartType, int polOrder>
class SIPDGDiscretization : public DiscretizationBase<GridPartType>
{
  typedef DiscretizationBase<GridPartType> BaseType;
...
template <class GridPartType, int polOrder>
class NewSIPDGDiscretization : public DiscretizationBase<GridPartType>
{
  typedef DiscretizationBase<GridPartType> BaseType;
...
public:
  ...
  NewSIPDGDiscretization(const GridPartType& gp, const BoundaryInfoType& info, const FunctionType& diff,
                         const FunctionType& forc, const FunctionType& dir, const FunctionType& neu)
    : BaseType(gp, info, diff, forc, dir, neu)
    , space_(BaseType::grid_part())
    , beta_(1.0)
...
template <class GridPartType, int polOrder>
class SWIPDGDiscretization : public DiscretizationBase<GridPartType>
{
  typedef DiscretizationBase<GridPartType> BaseType;
...
public:
  ...
  SWIPDGDiscretization(const GridPartType& gp, const BoundaryInfoType& info, const FunctionType& diff,
                       const FunctionType& forc, const FunctionType& dir, const FunctionType& neu)
    : BaseType(gp, info, diff, forc, dir, neu)
    , space_(BaseType::grid_part())
