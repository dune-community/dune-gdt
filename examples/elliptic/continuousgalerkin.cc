...
int main(int argc, char** argv)
{
  try {
    ...
    const std::shared_ptr<const FunctionType> diffusion(FunctionType::create(settings.sub("diffusion")));
    const std::shared_ptr<const FunctionType> force(FunctionType::create(settings.sub("force")));
    const std::shared_ptr<const FunctionType> dirichlet(FunctionType::create(settings.sub("dirichlet")));
    const std::shared_ptr<const FunctionType> neumann(FunctionType::create(settings.sub("neumann")));
