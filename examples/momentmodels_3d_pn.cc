...
int main(int argc, char** argv)
{
  ...
  // moment_order is the polynomial order of the real spherical harmonics basis, the number of moments is
  // (moment_order+1)^2
  static constexpr size_t moment_order = 3;

  using MomentBasis = RealSphericalHarmonicsMomentBasis<double, double, moment_order>;
