...
class SingleConstraint{
  public:
  typedef typename FunctionalType::Codim                      Codim;
  typedef typename FunctionalType::DiscreteFunctionSpace      DiscreteFunctionSpace;

  private:
  typedef typename DiscreteFunctionSpace::BaseFunctionSetType BaseFunctionSetType;
	typedef typename DiscreteFunctionSpace::DiscreteFunction    DiscreteFunctionType;
...
class ConstraintsInterface{
  ...
  typedef typename FunctionalType::Codim                      Codim;
  typedef typename FunctionalType::DiscreteFunctionSpace      DiscreteFunctionSpace;
	typedef  SingleConstraint<FunctionalType>                   SingleConstraintType;
  ...
  typedef typename LeafIterator::Entity                       EntityType;
	...
	public:
		...
		/*
		 * @brief apply all constraints on Entity en and fills sparse matrix pplys the local base function bf on entity en to the constraint defined 
		 * by the functional returned by getFunctional() 
	   *
	   * @param en the entity
	   * @param bf the local base function
 ...
 */
template <class FunctionalType>
class ConstraintsDefault: public ConstraintsInterface<FunctionalType>{
public:
 ...
 */
template<class FunctionalType>
class NeumannBoundaryConstraints:public ConstraintsDefault<FunctionalType >{
 ...
 */
template<class FunctionalType>
class VectorConstraints:public ConstraintsDefault<FunctionalType> {
  public:
  typedef typename FunctionalType::Codim                      Codim;
  typedef typename FunctionalType::DiscreteFunctionSpace      DiscreteFunctionSpace;
	typedef SingleConstraint<FunctionalType>                    SingleConstraintType;
