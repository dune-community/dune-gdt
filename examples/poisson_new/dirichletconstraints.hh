...
namespace Dune 
{
  ...
  public:
    ...
    typedef SlaveDofs< DiscreteFunctionSpaceType, MapperType >
      SlaveDofsType;
    typedef typename SlaveDofsType::SingletonKey
      SlaveDofsKeyType;                                      /*@\label{poi:singleton}@*/
    ...
    void applyToOperatorLocal( LinearOperator& linearOperator, 
    ...
    {                                                      /*@LST0E@*/
      ...
      typedef typename IntersectionIteratorType::Intersection
        IntersectionType;
      typedef typename LinearOperator::LocalMatrixType
        LocalMatrixType;
