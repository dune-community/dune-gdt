...
int main(int argc, char** argv)
{
  try {
    ...
    typedef DiscreteFunctionSpace::Continuous::Lagrange<FunctionSpaceType, GridViewType, polOrder> DiscreteH1Type;
    ...
    //    DiscreteFunctionType boundaryData = Dune::FemTools::Function::createFromVector< DiscreteFunctionType >(
    //    discreteH1.hostSpace(), discreteH1G.affineShift().storage() );
