...
int main(int argc, char** argv)
{
  try {
    ...
    // integration
    typedef LocalOperation::Integrator::Codim0<FunctionSpaceType, ProductOperationType> ProductIntegratorType;

    ProductIntegratorType productIntegrator(productOperation);

    typedef LocalOperation::Integrator::Codim0<FunctionSpaceType, EllipticOperationType> EllipticIntegratorType;
