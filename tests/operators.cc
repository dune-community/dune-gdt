...
// +------------------------------+
typedef testing::
    Types<Dune::GDT::ContinuousLagrangeSpace::FemWrapper<S1dLeafGridPartType, 1, double, 1>,
          Dune::GDT::ContinuousLagrangeSpace::FemWrapper<S2dLeafGridPartType, 1, double, 1>,
          Dune::GDT::ContinuousLagrangeSpace::FemWrapper<S3dLeafGridPartType, 1, double, 1>
...
template <class SpaceType>
struct LagrangeProjectionOperator : public ::testing::Test
{
  typedef typename SpaceType::GridPartType GridPartType;
  typedef typename GridPartType::GridType GridType;
  typedef Dune::Stuff::GridProviderCube<GridType> GridProviderType;
...
template <class SpaceType>
struct GenericProjectionOperator : public ::testing::Test
{
  typedef typename SpaceType::GridPartType GridPartType;
  typedef typename GridPartType::GridType GridType;
  typedef Dune::Stuff::GridProviderCube<GridType> GridProviderType;
...
typedef testing::Types<
    ...
    std::pair<Dune::GDT::ContinuousLagrangeSpace::FemWrapper<AluConform2dLevelGridPartType, 1, double, 1>,
              Dune::GDT::DiscontinuousLagrangeSpace::FemLocalfunctionsWrapper<AluConform2dLevelGridPartType, 1, double,
                                                                              1>>,
    std::pair<Dune::GDT::ContinuousLagrangeSpace::FemLocalfunctionsWrapper<AluConform2dLevelGridPartType, 1, double, 1>,
              Dune::GDT::DiscontinuousLagrangeSpace::FemLocalfunctionsWrapper<AluConform2dLevelGridPartType, 1, double,
                                                                              1>>,
    std::pair<Dune::GDT::DiscontinuousLagrangeSpace::FemLocalfunctionsWrapper<AluConform2dLevelGridPartType, 1, double,
                                                                              1>,
              Dune::GDT::DiscontinuousLagrangeSpace::FemLocalfunctionsWrapper<AluConform2dLevelGridPartType, 1, double,
                                                                              1>>
    ...
    std::pair<Dune::GDT::ContinuousLagrangeSpace::FemWrapper<AluSimplex2dLevelGridPartType, 1, double, 1>,
              Dune::GDT::DiscontinuousLagrangeSpace::FemLocalfunctionsWrapper<AluSimplex2dLevelGridPartType, 1, double,
                                                                              1>>,
    std::pair<Dune::GDT::ContinuousLagrangeSpace::FemLocalfunctionsWrapper<AluSimplex2dLevelGridPartType, 1, double, 1>,
              Dune::GDT::DiscontinuousLagrangeSpace::FemLocalfunctionsWrapper<AluSimplex2dLevelGridPartType, 1, double,
                                                                              1>>,
    std::pair<Dune::GDT::DiscontinuousLagrangeSpace::FemLocalfunctionsWrapper<AluSimplex2dLevelGridPartType, 1, double,
                                                                              1>,
              Dune::GDT::DiscontinuousLagrangeSpace::FemLocalfunctionsWrapper<AluSimplex2dLevelGridPartType, 1, double,
                                                                              1>>
    ...
    std::pair<Dune::GDT::ContinuousLagrangeSpace::FemWrapper<AluSimplex3dLevelGridPartType, 1, double, 1>,
              Dune::GDT::DiscontinuousLagrangeSpace::FemLocalfunctionsWrapper<AluSimplex3dLevelGridPartType, 1, double,
                                                                              1>>,
    std::pair<Dune::GDT::ContinuousLagrangeSpace::FemLocalfunctionsWrapper<AluSimplex3dLevelGridPartType, 1, double, 1>,
              Dune::GDT::DiscontinuousLagrangeSpace::FemLocalfunctionsWrapper<AluSimplex3dLevelGridPartType, 1, double,
                                                                              1>>,
    std::pair<Dune::GDT::DiscontinuousLagrangeSpace::FemLocalfunctionsWrapper<AluSimplex3dLevelGridPartType, 1, double,
                                                                              1>,
              Dune::GDT::DiscontinuousLagrangeSpace::FemLocalfunctionsWrapper<AluSimplex3dLevelGridPartType, 1, double,
                                                                              1>>
#endif
...
template <class P>
struct L2ProlongationOperator : public ::testing::Test
{
...
typedef testing::Types<
    ...
    ,
    std::pair<Dune::GDT::ContinuousLagrangeSpace::FemWrapper<AluConform2dLevelGridPartType, 1, double, 1>,
              Dune::GDT::ContinuousLagrangeSpace::FemLocalfunctionsWrapper<AluConform2dLevelGridPartType, 1, double,
                                                                           1>>,
    std::pair<Dune::GDT::ContinuousLagrangeSpace::FemLocalfunctionsWrapper<AluConform2dLevelGridPartType, 1, double, 1>,
              Dune::GDT::ContinuousLagrangeSpace::FemLocalfunctionsWrapper<AluConform2dLevelGridPartType, 1, double,
                                                                           1>>,
    ...
    ,
    std::pair<Dune::GDT::ContinuousLagrangeSpace::FemWrapper<AluSimplex2dLevelGridPartType, 1, double, 1>,
              Dune::GDT::ContinuousLagrangeSpace::FemLocalfunctionsWrapper<AluSimplex2dLevelGridPartType, 1, double,
                                                                           1>>,
    std::pair<Dune::GDT::ContinuousLagrangeSpace::FemLocalfunctionsWrapper<AluSimplex2dLevelGridPartType, 1, double, 1>,
              Dune::GDT::ContinuousLagrangeSpace::FemLocalfunctionsWrapper<AluSimplex2dLevelGridPartType, 1, double,
                                                                           1>>,
    ...
    ,
    std::pair<Dune::GDT::ContinuousLagrangeSpace::FemWrapper<AluSimplex3dLevelGridPartType, 1, double, 1>,
              Dune::GDT::ContinuousLagrangeSpace::FemLocalfunctionsWrapper<AluSimplex3dLevelGridPartType, 1, double,
                                                                           1>>,
    std::pair<Dune::GDT::ContinuousLagrangeSpace::FemLocalfunctionsWrapper<AluSimplex3dLevelGridPartType, 1, double, 1>,
              Dune::GDT::ContinuousLagrangeSpace::FemLocalfunctionsWrapper<AluSimplex3dLevelGridPartType, 1, double,
                                                                           1>>,
...
template <class P>
struct LagrangeProlongationOperator : public ::testing::Test
{
  typedef typename P::first_type CoarseSpaceType;
  typedef typename P::second_type FineSpaceType;
  typedef typename FineSpaceType::GridPartType GridPartType;
