...
private:
  ...
  double compute_nonconformity_estimator()
  {
    ...
    const Product::Elliptic< typename TestCase::DiffusionType, GridViewType >
        elliptic_product(test_.diffusion(), grid_view);
    return std::sqrt(elliptic_product.apply2(difference, difference, over_integrate));
  ...
  double compute_residual_estimator_ESV07()
  {
    ...
    const Product::WeightedL2< GridViewType, CutoffFunctionType >
