...
private:
  ...
  double compute_nonconformity_estimator()
  {
    ...
    return make_elliptic_operator(grid_view, test_.diffusion(), over_integrate)
        ->induced_norm(discrete_solution - oswald_interpolation);
  ...
  double compute_residual_estimator_ESV07()
  {
    ...
    return make_weighted_l2_operator(grid_view, cutoff_function, over_integrate)
        ->induced_norm(test_.force() - p0_force);
