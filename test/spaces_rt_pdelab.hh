...
#define SPACE_RT_PDELAB_SGRID_LEVEL(dd) \
  Dune::GDT::Spaces::RT::PdelabBased< S ## dd ## dLevelGridViewType, 0, double, dd >
...
#define SPACES_RT_PDELAB_LEVEL \
  ...
  , SPACE_RT_PDELAB_SGRID_LEVEL(3) \
  , SPACE_RT_PDELAB_YASPGRID_LEVEL(2) \
  , SPACE_RT_PDELAB_YASPGRID_LEVEL(3)
...
#define SPACES_RT_PDELAB_ALUGRID_LEVEL \
  ...
  , SPACE_RT_PDELAB_ALUCUBEGRID_LEVEL(2) \
  , SPACE_RT_PDELAB_ALUCUBEGRID_LEVEL(3)
