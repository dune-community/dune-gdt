...
struct L2LocalizableProduct : public WeightedL2LocalizableProduct<SpaceType>
{
...
template <class SpaceType>
struct L2AssemblableProduct : public WeightedL2ProductBase<SpaceType>
{
...
template <class SpaceType>
struct L2Product : public WeightedL2ProductBase<SpaceType>
{
  typedef WeightedL2ProductBase<SpaceType> BaseType;
  typedef typename BaseType::RangeFieldType RangeFieldType;
  typedef typename BaseType::FunctionType FunctionType;
