...
public:
  ...
  typedef Dune::GDT::Spaces::CG::PdelabBased<GridViewType, polOrder, RangeFieldType, dimRange> SpaceType;
  ...
  void assemble() const
  {
    ...
    if (!is_assembled_) {
      ...
      Spaces::Constraints::Dirichlet<typename GridViewType::Intersection, RangeFieldType> dirichlet_constraints(
