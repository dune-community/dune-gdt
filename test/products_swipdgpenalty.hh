...
struct SwipdgPenaltyProductBase : public ::testing::Test
{
  ...
  typedef Stuff::Functions::Constant<EntityType, DomainFieldType, dimDomain, RangeFieldType, dimDomain, dimDomain>
      TensorType;
  typedef Stuff::Functions::Checkerboard<EntityType, DomainFieldType, dimDomain, RangeFieldType, dimRange>
      JumpFunctionType;
...
template <class SpaceType>
struct SwipdgPenaltyLocalizableProduct : public SwipdgPenaltyProductBase<SpaceType>
{
...
template <class SpaceType>
struct SwipdgPenaltyAssemblableProduct : public SwipdgPenaltyProductBase<SpaceType>
{
  typedef SwipdgPenaltyProductBase<SpaceType> BaseType;
  typedef typename BaseType::RangeFieldType RangeFieldType;
  typedef typename BaseType::ScalarType ScalarType;
  ...
  {
    // create the product
    Products::SwipdgPenaltyAssemblable<MatrixType, ScalarType, TensorType, SpaceType, GridViewType, SpaceType> product(
        this->space_, this->one_, this->unit_matrix_);
  ...
  void fulfills_interface() const
  {
    typedef Products::SwipdgPenaltyAssemblable<MatrixType, ScalarType, TensorType, SpaceType, GridViewType, SpaceType>
        ProductType;
...
template <class SpaceType>
struct SwipdgPenaltyProduct : public SwipdgPenaltyProductBase<SpaceType>
{
  typedef SwipdgPenaltyProductBase<SpaceType> BaseType;
  typedef typename BaseType::RangeFieldType RangeFieldType;
  typedef typename BaseType::ScalarType ScalarType;
