...
#define SGRID_TYPES(dim) \
  typedef typename Dune::GDT::SpaceTools::LeafGridPartView<  Dune::SGrid< dim, dim >, false >::Type S ## dim ## dLeafGridPartType; \
  typedef typename Dune::GDT::SpaceTools::LevelGridPartView< Dune::SGrid< dim, dim >, false >::Type S ## dim ## dLevelGridPartType; \
  typedef typename Dune::GDT::SpaceTools::LeafGridPartView<  Dune::SGrid< dim, dim >, true  >::Type S ## dim ## dLeafGridViewType; \
  typedef typename Dune::GDT::SpaceTools::LevelGridPartView< Dune::SGrid< dim, dim >, true  >::Type S ## dim ## dLevelGridViewType;
SGRID_TYPES(1)
SGRID_TYPES(2)
SGRID_TYPES(3)
#undef SGRID_TYPES
...
#define YASPGRID_TYPES(dim) \
  typedef typename Dune::GDT::SpaceTools::LeafGridPartView<  Dune::YaspGrid< dim >, false >::Type Yasp ## dim ## dLeafGridPartType; \
  typedef typename Dune::GDT::SpaceTools::LevelGridPartView< Dune::YaspGrid< dim >, false >::Type Yasp ## dim ## dLevelGridPartType; \
  typedef typename Dune::GDT::SpaceTools::LeafGridPartView<  Dune::YaspGrid< dim >, true  >::Type Yasp ## dim ## dLeafGridViewType; \
  typedef typename Dune::GDT::SpaceTools::LevelGridPartView< Dune::YaspGrid< dim >, true  >::Type Yasp ## dim ## dLevelGridViewType;
YASPGRID_TYPES(1)
YASPGRID_TYPES(2)
YASPGRID_TYPES(3)
...
typedef typename Dune::GDT::SpaceTools::LeafGridPartView<  AluConform3dGridType, false >::Type AluConform3dLeafGridPartType;
typedef typename Dune::GDT::SpaceTools::LevelGridPartView< AluConform3dGridType, false >::Type AluConform3dLevelGridPartType;
typedef typename Dune::GDT::SpaceTools::LeafGridPartView<  AluConform3dGridType, true  >::Type AluConform3dLeafGridViewType;
typedef typename Dune::GDT::SpaceTools::LevelGridPartView< AluConform3dGridType, true  >::Type AluConform3dLevelGridViewType;
