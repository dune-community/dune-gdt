...
#define SPACE_FV_SGRID(dd, rr) Dune::GDT::Spaces::FV::Default<S##dd##dLeafGridViewType, double, rr>

#define SPACE_FV_YASPGRID(dd, rr) Dune::GDT::Spaces::FV::Default<Yasp##dd##dLeafGridViewType, double, rr>
...
#define SPACE_FV_ALUCUBEGRID(dd, rr) Dune::GDT::Spaces::FV::Default<AluCube##dd##dLeafGridViewType, double, rr>
