...
#define SPACE_FV_SGRID(dd, rr) \
  Spaces::FiniteVolume::Default< S ## dd ## dLeafGridViewType, double, rr >

#define SPACE_FV_YASPGRID(dd, rr) \
  Spaces::FiniteVolume::Default< Yasp ## dd ## dLeafGridViewType, double, rr >
...
#define SPACE_FV_ALUSIMPLEXGRID(dd, rr) \
    Spaces::FiniteVolume::Default< AluSimplex ## dd ## dLeafGridViewType, double, rr >

#define SPACE_FV_ALUCUBEGRID(dd, rr) \
    Spaces::FiniteVolume::Default< AluCube ## dd ## dLeafGridViewType, double, rr >

#define SPACES_FV_ALUGRID \
    SPACE_FV_ALUSIMPLEXGRID(2, 1) \
  , SPACE_FV_ALUSIMPLEXGRID(2, 2) \
  , SPACE_FV_ALUSIMPLEXGRID(2, 3) \
  , SPACE_FV_ALUSIMPLEXGRID(3, 1) \
  , SPACE_FV_ALUSIMPLEXGRID(3, 2) \
  , SPACE_FV_ALUSIMPLEXGRID(3, 3) \
